...
>
> **Try it:** Place your cursor inside any colored text and press **Alt+Cmd+Y** to accept or **Alt+Cmd+N[^ct-6.1]** to reject.

---

# Project Status Update[^ct-5]
...
This quarter we shipped the new notification system, migrated the database to PostgreSQL, and {++began planning the v2 API redesign++}[^ct-1]. The team is on track for the March milestone.

{--We are also evaluating a move to microservices, but no decision has been made yet.--}[^ct-2]

## Key Metrics

| Metric | Q4 2025 | Q1 2026 | Change |
|--------|---------|---------|--------|
| API latency (p99) | 240ms | 145ms[^ct-3] | -40% |
...
3. {==Hire two senior engineers for the platform team==}{>>Is this confirmed? Last I heard, headcount was still pending finance approval.<<}[^ct-4]

---

**Try it yourself:** Turn on **Tracking** (dot icon in the title bar) and edit this document. Your changes will be wrapped automatically. Use **Alt+Cmd+Y** to accept and **Alt+Cmd+N**[^ct-6.2] to reject the changes above.
...
[^ct-2]: @ai:claude-sonnet-4-5 | 2026-02-15 | del | proposed
...
[^ct-3]: @hackerbara | 2026-02-14 | sub | accepted
...
[^ct-4]: @jordan | 2026-02-15 | highlight | proposed
...
[^ct-5]: @ai:claude-opus-4.6 | 2026-02-28 | sub | accepted
...
[^ct-6.1]: @ai:claude-opus-4.6 | 2026-02-28 | sub | accepted
...
[^ct-6.2]: @ai:claude-opus-4.6 | 2026-02-28 | sub | accepted
    @ai:claude-opus-4.6 2026-02-28: Update keybinding references to new Alt+Cmd scheme
    approved: @ai:claude-opus-4.6 2026-02-28 "Update keybinding references to new Alt+Cmd scheme"

[^ct-6]: @ai:claude-opus-4.6 | 2026-02-28 | group | proposed
