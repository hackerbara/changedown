...
Feature: Settings tab — project configuration GUI
  ...
  I want to configure ChangeTracks's tracking policies from a visual form
  So I don't have to manually edit .changetracks/config.toml
  ...
  #    verify that .changetracks/config.toml was written with the new
