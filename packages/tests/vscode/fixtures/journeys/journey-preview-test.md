...
The API now includes {++an important addition for rate limiting++}[^cn-1] to protect endpoints.

The transport layer uses {~~REST~>GraphQL~~}[^cn-2] for the public interface.

{--Legacy XML support has been removed from the codebase.--}[^cn-3]

The documentation was {==carefully reviewed==}{>>needs final sign-off<<} before release.

[^cn-1]: @ai:claude | 2026-02-15T09:00:00Z | ins | accepted
...
[^cn-2]: @ai:claude | 2026-02-15T09:01:00Z | sub | accepted
  GraphQL provides better query flexibility for clients
  approved: @human:bob 2026-02-15

[^cn-3]: @ai:claude | 2026-02-15T09:02:00Z | del | rejected
