...
The service mesh will use {++Envoy sidecars for all inter-service communication++}[^cn-1] rather than direct HTTP calls.

{==Connection pooling configuration needs load testing under production traffic patterns.==}[^cn-2]
...
[^cn-2]: @bob | 2026-03-02 | hl | proposed
