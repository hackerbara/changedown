...
Feature: Review with reason
  ...
  Scenario: Accept with reason records approval line
    When I review ct-1 with decision "accepted" and reason "Clear addition" by "bob" on "2026-03-09"
  ...
  Scenario: Reject with reason records rejection line
    When I review ct-1 with decision "rejected" and reason "Duplicates existing" by "bob" on "2026-03-09"
  ...
  Scenario: Accept without reason when optional
    When I review ct-1 with decision "accepted" without reason by "bob" on "2026-03-09"
  ...
  Scenario: Request changes does not change status
    When I review ct-1 with decision "request-changes" and reason "Needs rewording" by "bob" on "2026-03-09"
