...
- **Throughput ceiling:** The PostgreSQL job queue saturates at approximately 12,000 events per minute. The platform now processes 45,000 events/minute at peak, causing queue backlogs of 20+ minutes during traffic spikes.
...
As noted in the migration phases above, each phase includes explicit rollback procedures to minimize risk during the transition.
