...
projections derive current state. See the foundational premise above.
<!-- Restructured: conclusion promoted to premise (§2); reference and Migration term updated. -->
...
Migrate existing audit logs to event format. The pre-event-sourcing approach is retained as a 
