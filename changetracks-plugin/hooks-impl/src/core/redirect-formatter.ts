...
export interface RedirectInput {
  ...
  fileContent: string;
  config: {
    protocol: { mode: 'classic' | 'compact' };
    hashline: { enabled: boolean };
  };
}

export function formatRedirect(input: RedirectInput): string {
...
function formatClassicRedirect(filePath: string, oldText: string, newText: string): string {
...
function formatCompactRedirect(
  filePath: string,
  oldText: string,
  newText: string,
  fileContent: string,
...
function formatWriteRedirect(
  filePath: string,
  oldContent: string,
  newContent: string,
  config: { protocol: { mode: string }; hashline: { enabled: boolean } },
): string {
...
export interface ReadRedirectConfig {
  policy?: { default_view?: string };
}

export function formatReadRedirect(
  filePath: string,
