...
process.stdin.on('end', () => {
  ...
  if (shouldBlock) {
    ...
    const response = {
      ...
      agentMessage: 'BLOCKED: This file is tracked by ChangeTracks. Use the read_tracked_file MCP tool instead of reading the file directly. Example: read_tracked_file(file="' + filePath + '")'
    };
