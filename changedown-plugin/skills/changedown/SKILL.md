...
# ChangeDown — Change Tracking for AI Agents
...
**What round-trips:** insertions, deletions, substitutions, author attribution, dates,
comment threads, images (including floating/anchored positioning), formatting (bold, italic).
