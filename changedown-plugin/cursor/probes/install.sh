#!/usr/bin/env bash
# Install ChangeDown hook probes into Cursor for experimental validation.
#
# Run from the project root:
#   ./changedown-plugin/cursor/probes/install.sh
#
...
#   3. Use a ChangeDown MCP tool (triggers beforeMCPExecution)
...
#
# To uninstall: ./changedown-plugin/cursor/probes/uninstall.sh
...
echo ""
echo "To uninstall: ./changedown-plugin/cursor/probes/uninstall.sh"
