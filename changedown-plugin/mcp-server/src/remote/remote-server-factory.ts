...
import { applyWordReviewChanges, assertWordSourceMutationCapability } from '../word-review.js';
...
const WORKFLOW_REMOTE_TOOLS = new Set<RemoteWordToolName>(['read_tracked_file', 'list_changes', 'propose_change', 'review_changes', 'supersede_change']);
