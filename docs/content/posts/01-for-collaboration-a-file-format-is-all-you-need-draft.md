...
Trying to get AI to reliably participate in and act on that context dance currently requires a messy constellation of correlation across git logs, MCP connections to apps, and command line binary tools. 
...
[^cn-3.1]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    9:c4 {~~These are rich UX questions many different people are circling. Beneath them all, I think something~>Beneath them all, something~~} is
    @ai:claude-opus-4.6 2026-04-02T05:15:26Z: cut filler framing sentence; "I think" appears twice in quick succession, removing first instance
    approved: @ 2026-04-02T15:53:07Z ""

[^cn-3.2]: @ai:claude-opus-4.6 | 2026-04-02 | del | accepted
    11:a8 old. {--You can manually see what changed. --}You
    @ai:claude-opus-4.6 2026-04-02T05:15:26Z: redundant with "you get a diff"
    approved: @ 2026-04-02T15:53:38Z ""

[^cn-3.3]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    15:35 {~~There are many important questions that a file format doesn't inherently solve: how you collaborate on edits in real-time with others, how humans and agents process through reviews, and how to make that all scale for AI outputs. These questions are all upstream of how the produced changes are crystallized and shared downstream with others.~>There are many important questions that a file format doesn't solve: how you collaborate on edits in real-time with others, how humans and agents process through reviews, and how to make that all scale for AI outputs. These questions are upstream of how changes are recorded and shared.~~}
    @ai:claude-opus-4.6 2026-04-02T05:15:26Z: "inherently" is filler; upstream/downstream/crystallized/shared doing too much at once
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-3.4]: @ai:claude-opus-4.6 | 2026-04-02 | del | accepted
    17:e9 {--What a file format gives is a clear sense of how changes and their history persist in the world, how versions of that history are exchanged, and what the shared participation language is for any human or AI.--}
    @ai:claude-opus-4.6 2026-04-02T05:15:26Z: restates line 13 ("content state lives in the world") and line 15 ("shared participation language"); line 19 picks up the thread fine without it
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-3.5]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    18:52 {~~It turns out that containing~>Containing~~} changes
    @ai:claude-opus-4.6 2026-04-02T05:15:26Z: "It turns out that" is filler
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-3]: @ai:claude-opus-4.6 | 2026-04-02 | group | proposed
    @ai:claude-opus-4.6 2026-04-02T05:15:26Z: propose_batch

[^cn-4.1]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    24:d7 {~~The in-body footnote tag provides basic location anchoring, with an algorithm for enhanced anchoring based on unique surrounding text and edit operations appended to the log when needed (drawing on the [W3C Web Annotation Data Model](https://www.w3.org/TR/annotation-model/) (2017) approach to robust text anchoring).~>The in-body footnote tag provides location anchoring, with enhanced anchoring based on unique surrounding text when needed (drawing on the [W3C Web Annotation Data Model](https://www.w3.org/TR/annotation-model/) (2017) approach to robust text anchoring).~~}
    @ai:claude-opus-4.6 2026-04-02T05:18:17Z: cuts "basic," "algorithm for," and "edit operations appended to the log" — tighter without losing meaning
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-4.2]: @ai:claude-opus-4.6 | 2026-04-02 | del | accepted
    41:cb {--Any text editor can read it. --}Git
    @ai:claude-opus-4.6 2026-04-02T05:18:17Z: restates "the characters in the file are the protocol"; also reduces repetition with "human-readable" / "any text editor" at line 96
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-4]: @ai:claude-opus-4.6 | 2026-04-02 | group | proposed
    @ai:claude-opus-4.6 2026-04-02T05:18:17Z: propose_batch

[^cn-5.1]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    49:1d {~~from media titans to compliance hawks, eagle-eyed copy editors to business consultants of all stripes, every corner of the legal professions, and beyond.~>from media titans to compliance hawks, copy editors to consultants, academic and research, and every corner of the legal professions.~~}
    @ai:claude-opus-4.6 2026-04-02T05:23:08Z: trim excess modifiers while adding academic/research per user request
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-5.2]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    51:3c {~~the underlying format is able to capture all of the different actions required in drafting and review into one coherent, versionable, shareable file. Hundreds of thousands of professionals have built decades of muscle memory parsing changes and their approvals through tools that speak docx, and there is currently no complete app~>the underlying format captures the actions required in drafting and review into one coherent, versionable, shareable file. Hundreds of thousands of professionals have built decades of muscle memory parsing changes and their approvals through tools that speak docx, and there is no complete app~~} or
    @ai:claude-opus-4.6 2026-04-02T05:23:08Z: "all of the different" and "currently" are filler
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-5.3]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    53:a4 {~~We can't and shouldn't expect human review professionals to give up on decades of hard-won muscle memory, and they don't need to. Changedown provides this same review process completeness in a format that AI can natively read and process with high token efficiency and low cognitive complexity, while producing edits and history that's directly readable by humans and progressively enhanced by complete review UX tooling.~>We can't expect review professionals to abandon that skill, and they don't need to. Changedown provides this same review process completeness in a format that AI can natively read and process with high token efficiency and low cognitive complexity, while producing edits and history readable by humans and progressively enhanced by tooling.~~}
    @ai:claude-opus-4.6 2026-04-02T05:23:08Z: third "muscle memory" / second "decades of" already earned in 51-53; "directly readable by humans" repeated from intro; fourth "complete"
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-5]: @ai:claude-opus-4.6 | 2026-04-02 | group | proposed
    @ai:claude-opus-4.6 2026-04-02T05:23:08Z: propose_batch

[^cn-6.1]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    57:c8 {~~Humans can also directly read Changedown files, and manually edit them, even though it is somewhat cumbersome. Being able to comprehend the contained file directly instead of having to rely on processing tools is an important building block~>Humans can read and manually edit Changedown files, even though it is somewhat cumbersome. Being able to comprehend the file directly is an important building block~~} of
    @ai:claude-opus-4.6 2026-04-02T05:24:53Z: "also" and "directly" are filler; "instead of having to rely on processing tools" restates the point just made
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-6.2]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    59:88 {~~And the established social expectations and rituals around file-based review cycles have tremendous inertia that is not worth fighting, and also contain tremendous wisdom in terms of how they encode participation expectations and agency.~>And the established social expectations around file-based review cycles have tremendous inertia that is not worth fighting — and contain real wisdom about how their rituals encode participation and agency.~~}
    @ai:claude-opus-4.6 2026-04-02T05:24:53Z: cuts duplicate "tremendous"; tighter phrasing per user preference
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-6]: @ai:claude-opus-4.6 | 2026-04-02 | group | proposed
    @ai:claude-opus-4.6 2026-04-02T05:24:53Z: propose_batch

[^cn-7.1]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    77:c5 {~~This means that the state has to live in the world, not in instructions they might forget. Changedown puts the editorial history in the bytes. An agent reads the file and gets the full picture — who proposed what, who approved it, what's still pending — without a separate tool call. The footnotes are right there. The format is the context.~>This means the state has to be in the file, not in instructions they might forget. Changedown puts the editorial history in the bytes. An agent reads the file and gets the full picture — who proposed what, who approved it, what's still pending — without a separate tool call. The format is the context.~~}
    @ai:claude-opus-4.6 2026-04-02T05:28:21Z: "live in the world" third occurrence swapped for concrete noun; "The footnotes are right there" restates "The format is the context"
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-7.2]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    79:73 {~~with reasons attached, expressed~>with reasons, expressed~~} in
    @ai:claude-opus-4.6 2026-04-02T05:28:21Z: "with reasons attached" is verbatim from line 23
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-7.3]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    81:03 {~~I measured this directly in preliminary benchmarking. On a 169-line document with 32 seeded errors, Claude Sonnet using Changedown completed the task in 3 tool calls. Raw file editing took 25 calls. Eight times fewer calls. Same quality. The difference wasn't the model — it was the harness and how hospitable its cognitive shape was.~>I measured this in early benchmarking. On a 169-line document with 32 seeded errors, Claude Sonnet using Changedown completed the task in 3 tool calls. Raw file editing took 25 calls. Eight times fewer calls. Same quality. The difference wasn't the model — it was the cognitive shape of the tools.~~}
    @ai:claude-opus-4.6 2026-04-02T05:28:21Z: "directly" overused; "preliminary" hedges; "cognitive shape of the tools" per user preference
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-7]: @ai:claude-opus-4.6 | 2026-04-02 | group | proposed
    @ai:claude-opus-4.6 2026-04-02T05:28:21Z: propose_batch

[^cn-8.1]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    94:55 {~~The result is diffable, mergeable, gittable, and human-readable. It works without any special tools — the markup is visible in any text editor. And~>The result is diffable, mergeable, gittable, and human-readable. And~~} when
    @ai:claude-opus-4.6 2026-04-02T05:30:04Z: "visible in any text editor" restates "human-readable" and echoes cut from line 43
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-8.2]: @ai:claude-opus-4.6 | 2026-04-02 | del | accepted
    98:f0 UIs. {--All of it will keep evolving — and it should.--}
    @ai:claude-opus-4.6 2026-04-02T05:30:04Z: filler wrap-up; the credits paragraph already implies ongoing work
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-8.3]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    100:f7 {~~But I do think that at the end of the day, every approach collaboration produces the same outputs: changes to text, with discussion and provenance and review attached.~>But I do think every approach to collaboration produces the same outputs: changes to text, with discussion, provenance, and review.~~} Microsoft
    @ai:claude-opus-4.6 2026-04-02T05:30:04Z: "at the end of the day" is filler; "with ... attached" echoes lines 23/81
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-8.4]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    110:ee {~~A file that can remember (and forget) everything it needs to on the journey to becoming shareable and real in the world.~>A file that can remember (and forget) everything it needs to on its journey to becoming real and shareable.~~}
    @ai:claude-opus-4.6 2026-04-02T05:30:04Z: fourth "in the world" across the piece; reordered per user preference
    approved: @ 2026-04-02T15:53:48Z ""

[^cn-8]: @ai:claude-opus-4.6 | 2026-04-02 | group | proposed
    @ai:claude-opus-4.6 2026-04-02T05:30:04Z: propose_batch
