...
`));return t.join(`
`)+`
`}function jl(e,t){let n=[...t].sort((e,t)=>t.range.start-e.range.start);for(let t of n)if(t.anchored!==!1)switch(t.type){case J.Insertion:e=e.slice(0,t.range.start)+e.slice(t.range.end);break;case J.Deletion:t.originalText&&(e=e.slice(0,t.range.start)+t.originalText+e.slice(t.range.start));break;case J.Substitution:t.originalText&&(e=e.slice(0,t.range.start)+t.originalText+e.slice(t.range.end));break}return e}function Ml(e){let t=El(e).getChanges().filter(e=>e.status===Y.Proposed),{bodyLines:n}=Ra(e.split(`
`)),r=n.join(`
...
`}return t+=`  </div>
`,t}function mu(e){if(!e)return``;if(e.type===`resolved`){let t=`  <div class="cn-fn-resolution cn-resolved">`;return t+=`<span class="cn-fn-resolution-icon">&#x2714;</span> resolved `,t+=`<span class="cn-fn-author">${Z(e.author)}</span> `,t+=`<span class="cn-fn-date">${Z(e.date)}</span>`,e.reason&&(t+=`: ${Z(e.reason)}`),t+=`</div>
...
`,t}function hu(e){return Z(e)}function gu(e,t,n,r){if(!r)return e;let i=t.metadata?.author;if(!i)return e;let a=r.getColor(i),o=n.isDarkTheme?a.dark:a.light;return e.replace(/^(<\w+)/,`$1 style="color: ${hu(o)}"`)}function _u(e,t){if(t===`badge`)return``;let n=e.metadata;if(!n)return``;if(t===`summary`){let t=[];n.author&&t.push(`<span class="cn-anchor-author">${Z(n.author)}</span>`);let r=cu(e.status),i=e.status.toLowerCase();return t.push(`<span class="cn-anchor-status ${hu(r)}">${Z(i)}</span>`),`<span class="cn-anchor-meta">${t.join(` `)}</span>`}if(t===`projected`){let t=[];n.author&&t.push(`<span class="cn-anchor-author">${Z(n.author)}</span>`),n.date&&t.push(`<span class="cn-anchor-date">${Z(n.date)}</span>`);let r=cu(e.status),i=e.status.toLowerCase();t.push(`<span class="cn-anchor-status ${hu(r)}">${Z(i)}</span>`),n.comment&&t.push(`<span class="cn-anchor-comment">${Z(n.comment)}</span>`);let a=n.approvals?.length??0,o=n.rejections?.length??0;if(a>0||o>0){let e=``;a>0&&(e+=`&#x2714;${a}`),o>0&&(e+=` &#x2718;${o}`),t.push(`<span class="cn-anchor-approvals">${e.trim()}</span>`)}return`<span class="cn-anchor-meta cn-anchor-projected">${t.join(` `)}</span>`}return``}function vu(e,t,n,r,i){let a=cu(e.status),o=lu(e),s=` data-cn-pair="cn-pair-${e.range.start}"`;if(e.moveRole===`from`){let i=t.slice(e.contentRange.start,e.contentRange.end),c=r.find(t=>t.groupId===e.groupId&&t.moveRole===`to`)?.id??``,l=c?` <a class="cn-move-label" href="#cn-fn-ref-${hu(c)}" title="moved to ${hu(c)}">&#x2192; moved</a>`:` <span class="cn-move-label">&#x2192; moved</span>`,u=_u(e,n.metadataDetail);return{start:e.range.start,end:e.range.end,html:`<del class="cn-move-from ${a}"${s}>${Z(i)}</del>${o}${u}${l}`}}if(e.moveRole===`to`){let c=t.slice(e.contentRange.start,e.contentRange.end),l=r.find(t=>t.groupId===e.groupId&&t.moveRole===`from`)?.id??``,u=l?`<a class="cn-move-label" href="#cn-fn-ref-${hu(l)}" title="moved from ${hu(l)}">&#x2190; moved here</a> `:`<span class="cn-move-label">&#x2190; moved here</span> `,d=_u(e,n.metadataDetail),f=gu(`<ins class="cn-move-to ${a}"${s}>${ou(c)}</ins>`,e,n,i);return{start:e.range.start,end:e.range.end,html:`${u}${f}${o}${d}`}}switch(e.type){case J.Insertion:{let r=e.modifiedText??t.slice(e.contentRange.start,e.contentRange.end),c=_u(e,n.metadataDetail),l=gu(`<ins class="cn-ins ${a}"${s}>${ou(r)}</ins>`,e,n,i);return{start:e.range.start,end:e.range.end,html:`${l}${o}${c}`}}case J.Deletion:{let r=e.originalText??t.slice(e.contentRange.start,e.contentRange.end),i=_u(e,n.metadataDetail);return{start:e.range.start,end:e.range.end,html:`<del class="cn-del ${a}"${s}>${ou(r)}</del>${o}${i}`}}case J.Substitution:{let t=e.originalText??``,r=e.modifiedText??``,c=_u(e,n.metadataDetail),l=gu(`<ins class="cn-sub-ins ${a}">${ou(r)}</ins>`,e,n,i);return{start:e.range.start,end:e.range.end,html:`<del class="cn-sub-del ${a}"${s}>${ou(t)}</del>${l}${o}${c}`}}case J.Highlight:{let r=e.originalText??t.slice(e.contentRange.start,e.contentRange.end),i=_u(e,n.metadataDetail),a=`<mark class="cn-hl"${s}>${ou(r)}</mark>`;return{start:e.range.start,end:e.range.end,html:`${a}${o}${i}`}}case J.Comment:{if(!n.showComments)return{start:e.range.start,end:e.range.end,html:``};let i=e.metadata?.comment??t.slice(e.contentRange.start,e.contentRange.end),a=_u(e,n.metadataDetail),c=s,l=r.indexOf(e),u=l>0?r[l-1]:void 0;return u&&u.type===J.Highlight&&e.range.start===u.range.end&&(c=` data-cn-pair="cn-pair-${u.range.start}"`),{start:e.range.start,end:e.range.end,html:`<span class="cn-comment"${c} title="${Z(i)}">&#x1F4AC;</span>${o}${a}`}}default:return null}}function yu(e){let t=[],n=/\[\^(cn-\d+(?:\.\d+)?)\]/g,r;for(;(r=n.exec(e))!==null;){let n=e.slice(r.index+r[0].length),i=e.slice(0,r.index).lastIndexOf(`
`)+1;if(r.index===i&&n.startsWith(`:`))continue;let a=r[1];t.push({start:r.index,end:r.index+r[0].length,html:`<sup class="cn-ref" id="cn-fn-ref-${Z(a)}" data-cn-id="${Z(a)}"><a href="#cn-fn-def-${Z(a)}">${Z(a)}</a></sup>`})}return t}function bu(e){return`  <span class="cn-ref-badge">${Z(e)}</span> <a class="cn-fn-backlink" href="#cn-fn-ref-${Z(e)}" title="Back to change">&#x21A9;</a>`}function xu(e,t,n,r){let i=[],a=/^(\[\^(cn-\d+(?:\.\d+)?)\]:[ \t]*)(.*)/gm,o,s=[],c=r??Sa(e);for(;(o=a.exec(e))!==null;){if(su(o.index,o.index+o[0].length,c))continue;let t=o[2],n=o[3],r=o.index,i=r+o[0].length,a=e.slice(i).search(/\n\s*\n|\n\[\^cn-/);a>=0?i+=a:i=e.length,s.push({start:r,end:i,id:t,firstLine:n})}if(s.length===0)return[];let l=s[0].start,u=s[s.length-1].end;if(!n.showFootnotes)return[{start:l,end:u,html:``}];let d=`<section class="cn-footnotes">
...
`):(d+=`<div class="cn-footnote" id="cn-fn-def-${Z(e.id)}" data-cn-id="${Z(e.id)}">\n`,d+=bu(e.id),r?.author&&(d+=` <span class="cn-fn-author">${Z(r.author)}</span>`),r?.date&&(d+=` <span class="cn-fn-date">${Z(r.date)}</span>`),r?.status&&(d+=` <span class="cn-fn-status cn-${Z(r.status)}">${Z(r.status)}</span>`),r?.comment&&(d+=`\n  <div class="cn-fn-comment">${Z(r.comment)}</div>`),d+=`
...
`)}return d+=`</section>`,i.push({start:l,end:u,html:d}),i}var Su=class{deltas=[];addDelta(e,t){let n=this.deltas.length>0?this.deltas[this.deltas.length-1].cumulativeDelta:0;this.deltas.push({rewrittenLine:e,cumulativeDelta:n+t})}toOriginal(e){if(this.deltas.length===0)return e;let t=0,n=this.deltas.length-1,r=0;for(;t<=n;){let i=t+n>>1;this.deltas[i].rewrittenLine<=e?(r=this.deltas[i].cumulativeDelta,t=i+1):n=i-1}return e-r}};function Cu(e,t,n){let r=0;for(let i=t;i<n;i++)e.charCodeAt(i)===10&&r++;return r}function wu(e,t,n,r){let i=Sa(e),a=[],o=n.authorColors??`auto`,s=au.shouldApplyColors(t,o)?new au:null;for(let r of t){if(su(r.range.start,r.range.end,i))continue;let o=vu(r,e,n,t,s);o&&a.push(o)}for(let t of yu(e))su(t.start,t.end,i)||(n.showFootnotes?a.push(t):a.push({start:t.start,end:t.end,html:``}));a.push(...xu(e,t,n,i)),a.sort((e,t)=>e.start-t.start||t.end-e.end);let c=[];for(let e of a){let t=c[c.length-1];if(t&&e.start<t.end){e.end-e.start>t.end-t.start&&(c[c.length-1]=e);continue}c.push(e)}if(r){let t=0;for(let n of c){let i=Cu(e,n.start,n.end),a=Cu(n.html,0,n.html.length)-i;if(a!==0){let i=Cu(e,0,n.start)+t;r.addDelta(i,a),t+=a}}}c.sort((e,t)=>t.start-e.start);let l=e;for(let e of c)l=l.slice(0,e.start)+e.html+l.slice(e.end);return l}var Tu=[`{++`,`{--`,`{~~`,`{==`,`{>>`];function Eu(e){return Tu.some(t=>e.includes(t))}function Du(e,t){let n=`cn-${e.status.toLowerCase()}`;switch(e.type){case J.Insertion:return`<ins class="cn-ins ${n}">${ou(e.modifiedText??t.slice(e.contentRange.start,e.contentRange.end))}</ins>`;case J.Deletion:return`<del class="cn-del ${n}">${ou(e.originalText??t.slice(e.contentRange.start,e.contentRange.end))}</del>`;case J.Substitution:{let t=e.originalText??``,r=e.modifiedText??``;return`<del class="cn-sub-del ${n}">${ou(t)}</del><ins class="cn-sub-ins ${n}">${ou(r)}</ins>`}case J.Highlight:return`<mark class="cn-hl">${ou(e.originalText??t.slice(e.contentRange.start,e.contentRange.end))}</mark>`;case J.Comment:return`<span class="cn-comment" title="${Z(e.metadata?.comment??t.slice(e.contentRange.start,e.contentRange.end))}">&#x1F4AC;</span>`;default:return Z(t.slice(e.range.start,e.range.end))}}function Ou(e,t){let n=new mc().parse(e).getChanges(),r=t?` class="language-${Z(t)}"`:``;if(n.length===0)return`<pre><code${r}>${Z(e)}</code></pre>\n`;let i=[...n].sort((e,t)=>e.range.start-t.range.start),a=[],o=0;for(let t of i)t.range.start>o&&a.push(Z(e.slice(o,t.range.start))),a.push(Du(t,e)),o=t.range.end;return o<e.length&&a.push(Z(e.slice(o))),`<pre><code${r}>${a.join(``)}</code></pre>\n`}var ku=new Set([`changedown`,`criticmarkup`]);function Au(e,t){let n={enabled:!0,showFootnotes:!0,showComments:!0,renderInCodeFences:!0,metadataDetail:`badge`,authorColors:`auto`,isDarkTheme:!1},r=t??(()=>n),i=new iu;e.core.ruler.before(`block`,`changedown`,e=>{let t=r();if(!t.enabled)return;let n=i.parse(e.src).getChanges();if(n.length>0){let r=i.isFootnoteNative(e.src),a=r?Ra(e.src.split(`
`)).bodyLines.join(`
`)+`
...
`).length,r=t.querySelector(`[data-source-line="${n}"]`);r&&r.scrollIntoView({behavior:`smooth`,block:`center`})}};Xe();function Xm(){Rt(()=>{let e=Wt.value;if(!e)return;let t=e.replace(/\.md$/,``),n=e===Ut?`/`:t;window.location.pathname!==n&&window.history.pushState({contentPath:e},``,n),document.title=`${e.split(`/`).pop()?.replace(/\.md$/,``)||`ChangeDown`} — ChangeDown`}),U(()=>{let e=e=>{let t=e.state?.contentPath;t&&Ro.exists(t).then(e=>{e&&(Wt.value=t)})};return window.addEventListener(`popstate`,e),()=>window.removeEventListener(`popstate`,e)},[])}var Zm=c({Children:()=>Ah,Component:()=>y,Fragment:()=>v,PureComponent:()=>ah,StrictMode:()=>v,Suspense:()=>uh,SuspenseList:()=>ph,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:()=>Kh,cloneElement:()=>Ch,createContext:()=>z,createElement:()=>h,createFactory:()=>yh,createPortal:()=>gh,createRef:()=>_,default:()=>Zh,findDOMNode:()=>Th,flushSync:()=>Yh,forwardRef:()=>sh,hydrate:()=>vh,isElement:()=>Xh,isFragment:()=>xh,isMemo:()=>Sh,isValidElement:()=>bh,lazy:()=>fh,memo:()=>oh,render:()=>_h,startTransition:()=>nh,unmountComponentAtNode:()=>wh,unstable_batchedUpdates:()=>Jh,useCallback:()=>Te,useContext:()=>Ee,useDebugValue:()=>De,useDeferredValue:()=>rh,useEffect:()=>U,useErrorBoundary:()=>Oe,useId:()=>ke,useImperativeHandle:()=>we,useInsertionEffect:()=>Eh,useLayoutEffect:()=>Ce,useMemo:()=>G,useReducer:()=>Se,useRef:()=>W,useState:()=>H,useSyncExternalStore:()=>eh,useTransition:()=>ih,version:()=>qh});function Qm(e,t){for(var n in t)e[n]=t[n];return e}function $m(e,t){for(var n in e)if(n!==`__source`&&!(n in t))return!0;for(var r in t)if(r!==`__source`&&e[r]!==t[r])return!0;return!1}function eh(e,t){var n=t(),r=H({t:{__:n,u:t}}),i=r[0].t,a=r[1];return Ce(function(){i.__=n,i.u=t,th(i)&&a({t:i})},[e,n,t]),U(function(){return th(i)&&a({t:i}),e(function(){th(i)&&a({t:i})})},[e]),n}function th(e){try{return!((t=e.__)===(n=e.u())&&(t!==0||1/t==1/n)||t!=t&&n!=n)}catch{return!0}var t,n}function nh(e){e()}function rh(e){return e}function ih(){return[!1,nh]}function ah(e,t){this.props=e,this.context=t}function oh(e,t){function n(e){var n=this.props.ref;return n!=e.ref&&n&&(typeof n==`function`?n(null):n.current=null),t?!t(this.props,e)||n!=e.ref:$m(this.props,e)}function r(t){return this.shouldComponentUpdate=n,h(e,t)}return r.displayName=`Memo(`+(e.displayName||e.name)+`)`,r.__f=r.prototype.isReactComponent=!0,r.type=e,r}function sh(e){function t(t){var n=Qm({},t);return delete n.ref,e(n,t.ref||null)}return t.$$typeof=Oh,t.render=e,t.prototype.isReactComponent=t.__f=!0,t.displayName=`ForwardRef(`+(e.displayName||e.name)+`)`,t}function ch(e,t,n){return e&&(e.__c&&e.__c.__H&&(e.__c.__H.__.forEach(function(e){typeof e.__c==`function`&&e.__c()}),e.__c.__H=null),(e=Qm({},e)).__c!=null&&(e.__c.__P===n&&(e.__c.__P=t),e.__c.__e=!0,e.__c=null),e.__k=e.__k&&e.__k.map(function(e){return ch(e,t,n)})),e}function lh(e,t,n){return e&&n&&(e.__v=null,e.__k=e.__k&&e.__k.map(function(e){return lh(e,t,n)}),e.__c&&e.__c.__P===t&&(e.__e&&n.appendChild(e.__e),e.__c.__e=!0,e.__c.__P=n)),e}function uh(){this.__u=0,this.o=null,this.__b=null}function dh(e){var t=e.__&&e.__.__c;return t&&t.__a&&t.__a(e)}function fh(e){var t,n,r,i=null;function a(a){if(t||(t=e()).then(function(e){e&&(i=e.default||e),r=!0},function(e){n=e,r=!0}),n)throw n;if(!r)throw t;return i?h(i,a):null}return a.displayName=`Lazy`,a.__f=!0,a}function ph(){this.i=null,this.l=null}function mh(e){return this.getChildContext=function(){return e.context},e.children}function hh(e){var t=this,n=e.h;if(t.componentWillUnmount=function(){R(null,t.v),t.v=null,t.h=null},t.h&&t.h!==n&&t.componentWillUnmount(),!t.v){for(var r=t.__v;r!==null&&!r.__m&&r.__!==null;)r=r.__;t.h=n,t.v={nodeType:1,parentNode:n,childNodes:[],__k:{__m:r.__m},contains:function(){return!0},namespaceURI:n.namespaceURI,insertBefore:function(e,n){this.childNodes.push(e),t.h.insertBefore(e,n)},removeChild:function(e){this.childNodes.splice(this.childNodes.indexOf(e)>>>1,1),t.h.removeChild(e)}}}R(h(mh,{context:t.context},e.__v),t.v)}function gh(e,t){var n=h(hh,{__v:e,h:t});return n.containerInfo=t,n}function _h(e,t,n){return t.__k??(t.textContent=``),R(e,t),typeof n==`function`&&n(),e?e.__c:null}function vh(e,t,n){return re(e,t),typeof n==`function`&&n(),e?e.__c:null}function yh(e){return h.bind(null,e)}function bh(e){return!!e&&e.$$typeof===Ph}function xh(e){return bh(e)&&e.type===v}function Sh(e){return!!e&&typeof e.displayName==`string`&&e.displayName.indexOf(`Memo(`)==0}function Ch(e){return bh(e)?ie.apply(null,arguments):e}function wh(e){return!!e.__k&&(R(null,e),!0)}function Th(e){return e&&(e.base||e.nodeType===1&&e)||null}var Eh,Dh,Oh,kh,Ah,jh,Mh,Nh,Ph,Fh,Ih,Lh,Rh,zh,Bh,Vh,Hh,Uh,Wh,Gh,Kh,qh,Jh,Yh,Xh,Zh,Q=o((()=>{be(),Xe(),Xe(),Eh=Ce,(ah.prototype=new y).isPureReactComponent=!0,ah.prototype.shouldComponentUpdate=function(e,t){return $m(this.props,e)||$m(this.state,t)},Dh=V.__b,V.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),Dh&&Dh(e)},Oh=typeof Symbol<`u`&&Symbol.for&&Symbol.for(`react.forward_ref`)||3911,kh=function(e,t){return e==null?null:O(O(e).map(t))},Ah={map:kh,forEach:kh,count:function(e){return e?O(e).length:0},only:function(e){var t=O(e);if(t.length!==1)throw`Children.only`;return t[0]},toArray:O},jh=V.__e,V.__e=function(e,t,n,r){if(e.then){for(var i,a=t;a=a.__;)if((i=a.__c)&&i.__c)return t.__e??(t.__e=n.__e,t.__k=n.__k),i.__c(e,t)}jh(e,t,n,r)},Mh=V.unmount,V.unmount=function(e){var t=e.__c;t&&(t.__z=!0),t&&t.__R&&t.__R(),t&&32&e.__u&&(e.type=null),Mh&&Mh(e)},(uh.prototype=new y).__c=function(e,t){var n=t.__c,r=this;r.o??=[],r.o.push(n);var i=dh(r.__v),a=!1,o=function(){a||r.__z||(a=!0,n.__R=null,i?i(c):c())};n.__R=o;var s=n.__P;n.__P=null;var c=function(){if(!--r.__u){if(r.state.__a){var e=r.state.__a;r.__v.__k[0]=lh(e,e.__c.__P,e.__c.__O)}var t;for(r.setState({__a:r.__b=null});t=r.o.pop();)t.__P=s,t.forceUpdate()}};r.__u++||32&t.__u||r.setState({__a:r.__b=r.__v.__k[0]}),e.then(o,o)},uh.prototype.componentWillUnmount=function(){this.o=[]},uh.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var n=document.createElement(`div`),r=this.__v.__k[0].__c;this.__v.__k[0]=ch(this.__b,n,r.__O=r.__P)}this.__b=null}var i=t.__a&&h(v,null,e.fallback);return i&&(i.__u&=-33),[h(v,null,t.__a?null:e.children),i]},Nh=function(e,t,n){if(++n[1]===n[0]&&e.l.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!==`t`||!e.l.size))for(n=e.i;n;){for(;n.length>3;)n.pop()();if(n[1]<n[0])break;e.i=n=n[2]}},(ph.prototype=new y).__a=function(e){var t=this,n=dh(t.__v),r=t.l.get(e);return r[0]++,function(i){var a=function(){t.props.revealOrder?(r.push(i),Nh(t,e,r)):i()};n?n(a):a()}},ph.prototype.render=function(e){this.i=null,this.l=new Map;var t=O(e.children);e.revealOrder&&e.revealOrder[0]===`b`&&t.reverse();for(var n=t.length;n--;)this.l.set(t[n],this.i=[1,0,this.i]);return e.children},ph.prototype.componentDidUpdate=ph.prototype.componentDidMount=function(){var e=this;this.l.forEach(function(t,n){Nh(e,n,t)})},Ph=typeof Symbol<`u`&&Symbol.for&&Symbol.for(`react.element`)||60103,Fh=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Ih=/^on(Ani|Tra|Tou|BeforeInp|Compo)/,Lh=/[A-Z0-9]/g,Rh=typeof document<`u`,zh=function(e){return(typeof Symbol<`u`&&typeof Symbol()==`symbol`?/fil|che|rad/:/fil|che|ra/).test(e)},y.prototype.isReactComponent=!0,[`componentWillMount`,`componentWillReceiveProps`,`componentWillUpdate`].forEach(function(e){Object.defineProperty(y.prototype,e,{configurable:!0,get:function(){return this[`UNSAFE_`+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})}),Bh=V.event,V.event=function(e){return Bh&&(e=Bh(e)),e.persist=function(){},e.isPropagationStopped=function(){return this.cancelBubble},e.isDefaultPrevented=function(){return this.defaultPrevented},e.nativeEvent=e},Hh={configurable:!0,get:function(){return this.class}},Uh=V.vnode,V.vnode=function(e){typeof e.type==`string`&&function(e){var t=e.props,n=e.type,r={},i=n.indexOf(`-`)==-1;for(var a in t){var o=t[a];if(!(a===`value`&&`defaultValue`in t&&o==null||Rh&&a===`children`&&n===`noscript`||a===`class`||a===`className`)){var s=a.toLowerCase();a===`defaultValue`&&`value`in t&&t.value==null?a=`value`:a===`download`&&!0===o?o=``:s===`translate`&&o===`no`?o=!1:s[0]===`o`&&s[1]===`n`?s===`ondoubleclick`?a=`ondblclick`:s!==`onchange`||n!==`input`&&n!==`textarea`||zh(t.type)?s===`onfocus`?a=`onfocusin`:s===`onblur`?a=`onfocusout`:Ih.test(a)&&(a=s):s=a=`oninput`:i&&Fh.test(a)?a=a.replace(Lh,`-$&`).toLowerCase():o===null&&(o=void 0),s===`oninput`&&r[a=s]&&(a=`oninputCapture`),r[a]=o}}n==`select`&&(r.multiple&&Array.isArray(r.value)&&(r.value=O(t.children).forEach(function(e){e.props.selected=r.value.indexOf(e.props.value)!=-1})),r.defaultValue!=null&&(r.value=O(t.children).forEach(function(e){e.props.selected=r.multiple?r.defaultValue.indexOf(e.props.value)!=-1:r.defaultValue==e.props.value}))),t.class&&!t.className?(r.class=t.class,Object.defineProperty(r,`className`,Hh)):t.className&&(r.class=r.className=t.className),e.props=r}(e),e.$$typeof=Ph,Uh&&Uh(e)},Wh=V.__r,V.__r=function(e){Wh&&Wh(e),Vh=e.__c},Gh=V.diffed,V.diffed=function(e){Gh&&Gh(e);var t=e.props,n=e.__e;n!=null&&e.type===`textarea`&&`value`in t&&t.value!==n.value&&(n.value=t.value==null?``:t.value),Vh=null},Kh={ReactCurrentDispatcher:{current:{readContext:function(e){return Vh.__n[e.__c].props.value},useCallback:Te,useContext:Ee,useDebugValue:De,useDeferredValue:rh,useEffect:U,useId:ke,useImperativeHandle:we,useInsertionEffect:Eh,useLayoutEffect:Ce,useMemo:G,useReducer:Se,useRef:W,useState:H,useSyncExternalStore:eh,useTransition:ih}}},qh=`18.3.1`,Jh=function(e,t){return e(t)},Yh=function(e,t){var n=V.debounceRendering;V.debounceRendering=function(e){return e()};var r=e(t);return V.debounceRendering=n,r},Xh=bh,Zh={useState:H,useId:ke,useReducer:Se,useEffect:U,useLayoutEffect:Ce,useInsertionEffect:Eh,useTransition:ih,useDeferredValue:rh,useSyncExternalStore:eh,startTransition:nh,useRef:W,useImperativeHandle:we,useMemo:G,useCallback:Te,useContext:Ee,useDebugValue:De,version:`18.3.1`,Children:Ah,render:_h,hydrate:vh,unmountComponentAtNode:wh,createPortal:gh,createElement:h,createContext:z,createFactory:yh,cloneElement:Ch,createRef:_,Fragment:v,isValidElement:bh,isElement:Xh,isFragment:xh,isMemo:Sh,findDOMNode:Th,Component:y,PureComponent:ah,memo:oh,forwardRef:sh,flushSync:Yh,unstable_batchedUpdates:Jh,StrictMode:v,Suspense:uh,SuspenseList:ph,lazy:fh,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Kh}}));function Qh(e,t){return function(n,...r){let i=new URL(e);return i.searchParams.set(`code`,n.toString()),r.forEach(e=>i.searchParams.append(`args[]`,e)),`${t} error #${n}; visit ${i} for the full message.`}}var $h=Qh(`https://base-ui.com/production-error`,`Base UI`);Q();var eg=z(void 0);function tg(e){let t=Ee(eg);if(e===!1&&t===void 0)throw Error($h(27));return t}Q();var ng={};function rg(e,t){let n=W(ng);return n.current===ng&&(n.current=e(t)),n}function ig(e,t,n,r){let i=rg(og).current;return sg(i,e,t,n,r)&&lg(i,[e,t,n,r]),i.callback}function ag(e){let t=rg(og).current;return cg(t,e)&&lg(t,e),t.callback}function og(){return{callback:null,cleanup:null,refs:[]}}function sg(e,t,n,r,i){return e.refs[0]!==t||e.refs[1]!==n||e.refs[2]!==r||e.refs[3]!==i}function cg(e,t){return e.refs.length!==t.length||e.refs.some((e,n)=>e!==t[n])}function lg(e,t){if(e.refs=t,t.every(e=>e==null)){e.callback=null;return}e.callback=n=>{if(e.cleanup&&=(e.cleanup(),null),n!=null){let r=Array(t.length).fill(null);for(let e=0;e<t.length;e+=1){let i=t[e];if(i!=null)switch(typeof i){case`function`:{let t=i(n);typeof t==`function`&&(r[e]=t);break}case`object`:i.current=n;break;default:}}e.cleanup=()=>{for(let e=0;e<t.length;e+=1){let n=t[e];if(n!=null)switch(typeof n){case`function`:{let t=r[e];typeof t==`function`?t():n(null);break}case`object`:n.current=null;break;default:}}}}}}Q();var ug=parseInt(qh,10);function dg(e){return ug>=e}Q();function fg(e){if(!bh(e))return null;let t=e,n=t.props;return(dg(19)?n?.ref:t.ref)??null}function pg(e,t){if(e&&!t)return e;if(!e&&t)return t;if(e||t)return{...e,...t}}function mg(e,t){let n={};for(let r in e){let i=e[r];if(t?.hasOwnProperty(r)){let e=t[r](i);e!=null&&Object.assign(n,e);continue}i===!0?n[`data-${r.toLowerCase()}`]=``:i&&(n[`data-${r.toLowerCase()}`]=i.toString())}return n}function hg(e,t){return typeof e==`function`?e(t):e}function gg(e,t){return typeof e==`function`?e(t):e}var _g={};function vg(e,t,n,r,i){let a={...wg(e,_g)};return t&&(a=bg(a,t)),n&&(a=bg(a,n)),r&&(a=bg(a,r)),i&&(a=bg(a,i)),a}function yg(e){if(e.length===0)return _g;if(e.length===1)return wg(e[0],_g);let t={...wg(e[0],_g)};for(let n=1;n<e.length;n+=1)t=bg(t,e[n]);return t}function bg(e,t){return Cg(t)?t(e):xg(e,t)}function xg(e,t){if(!t)return e;for(let n in t){let r=t[n];switch(n){case`style`:e[n]=pg(e.style,r);break;case`className`:e[n]=Dg(e.className,r);break;default:Sg(n,r)?e[n]=Tg(e[n],r):e[n]=r}}return e}function Sg(e,t){let n=e.charCodeAt(0),r=e.charCodeAt(1),i=e.charCodeAt(2);return n===111&&r===110&&i>=65&&i<=90&&(typeof t==`function`||t===void 0)}function Cg(e){return typeof e==`function`}function wg(e,t){return Cg(e)?e(t):e??_g}function Tg(e,t){return t?e?n=>{if(Og(n)){let r=n;Eg(r);let i=t(r);return r.baseUIHandlerPrevented||e?.(r),i}let r=t(n);return e?.(n),r}:t:e}function Eg(e){return e.preventBaseUIHandler=()=>{e.baseUIHandlerPrevented=!0},e}function Dg(e,t){return t?e?t+` `+e:t:e}function Og(e){return typeof e==`object`&&!!e&&`nativeEvent`in e}function kg(){}Object.freeze([]);var Ag=Object.freeze({}),jg={clipPath:`inset(50%)`,position:`fixed`,top:0,left:0};Q();function Mg(e,t,n={}){let r=t.render,i=Ng(t,n);return n.enabled===!1?null:Fg(e,r,i,n.state??Ag)}function Ng(e,t={}){let{className:n,style:r,render:i}=e,{state:a=Ag,ref:o,props:s,stateAttributesMapping:c,enabled:l=!0}=t,u=l?hg(n,a):void 0,d=l?gg(r,a):void 0,f=l?mg(a,c):Ag,p=l?pg(f,Array.isArray(s)?yg(s):s)??Ag:Ag;return typeof document<`u`&&(l?Array.isArray(o)?p.ref=ag([p.ref,fg(i),...o]):p.ref=ig(p.ref,fg(i),o):ig(null,null)),l?(u!==void 0&&(p.className=Dg(p.className,u)),d!==void 0&&(p.style=pg(p.style,d)),p):Ag}var Pg=Symbol.for(`react.lazy`);function Fg(e,t,n,r){if(t){if(typeof t==`function`)return t(n,r);let e=vg(n,t.props);e.ref=n.ref;let i=t;return i?.$$typeof===Pg&&(i=Ah.toArray(t)[0]),Ch(i,e)}if(e&&typeof e==`string`)return Ig(e,n);throw Error($h(8))}function Ig(e,t){return e===`button`?h(`button`,{type:`button`,...t,key:t.key}):e===`img`?h(`img`,{alt:``,...t,key:t.key}):h(e,t)}var Lg=function(e){return e.startingStyle=`data-starting-style`,e.endingStyle=`data-ending-style`,e}({}),Rg={[Lg.startingStyle]:``},zg={[Lg.endingStyle]:``},Bg={transitionStatus(e){return e===`starting`?Rg:e===`ending`?zg:null}},Vg=function(e){return e.open=`data-open`,e.closed=`data-closed`,e[e.startingStyle=Lg.startingStyle]=`startingStyle`,e[e.endingStyle=Lg.endingStyle]=`endingStyle`,e.anchorHidden=`data-anchor-hidden`,e.side=`data-side`,e.align=`data-align`,e}({}),Hg=function(e){return e.popupOpen=`data-popup-open`,e.pressed=`data-pressed`,e}({});Hg.popupOpen,Hg.popupOpen,Hg.pressed;var Ug={[Vg.open]:``},Wg={[Vg.closed]:``},Gg={[Vg.anchorHidden]:``},Kg={open(e){return e?Ug:Wg},anchorHidden(e){return e?Gg:null}},qg=function(e){return e.nestedDrawers=`--nested-drawers`,e.height=`--drawer-height`,e.frontmostHeight=`--drawer-frontmost-height`,e.swipeMovementX=`--drawer-swipe-movement-x`,e.swipeMovementY=`--drawer-swipe-movement-y`,e.snapPointOffset=`--drawer-snap-point-offset`,e.swipeStrength=`--drawer-swipe-strength`,e}({}),Jg=function(e){return e.swipeProgress=`--drawer-swipe-progress`,e}({});Q();var Yg={...Kg,...Bg},Xg=sh(function(e,t){let{render:n,className:r,forceRender:i=!1,...a}=e,{store:o}=tg(),s=o.useState(`open`),c=o.useState(`nested`),l=o.useState(`mounted`);return Mg(`div`,e,{state:{open:s,transitionStatus:o.useState(`transitionStatus`)},ref:[o.context.backdropRef,t],stateAttributesMapping:Yg,props:[{role:`presentation`,hidden:!l,style:{pointerEvents:s?void 0:`none`,userSelect:`none`,WebkitUserSelect:`none`,[Jg.swipeProgress]:`0`,[qg.swipeStrength]:`1`}},a],enabled:i||!c})});function Zg(){return typeof window<`u`}function Qg(e){return t_(e)?(e.nodeName||``).toLowerCase():`#document`}function $g(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function e_(e){return((t_(e)?e.ownerDocument:e.document)||window.document)?.documentElement}function t_(e){return Zg()?e instanceof Node||e instanceof $g(e).Node:!1}function n_(e){return Zg()?e instanceof Element||e instanceof $g(e).Element:!1}function r_(e){return Zg()?e instanceof HTMLElement||e instanceof $g(e).HTMLElement:!1}function i_(e){return!Zg()||typeof ShadowRoot>`u`?!1:e instanceof ShadowRoot||e instanceof $g(e).ShadowRoot}function a_(e){let{overflow:t,overflowX:n,overflowY:r,display:i}=l_(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&i!==`inline`&&i!==`contents`}var o_;function s_(){return o_??=typeof CSS<`u`&&CSS.supports&&CSS.supports(`-webkit-backdrop-filter`,`none`),o_}function c_(e){return/^(html|body|#document)$/.test(Qg(e))}function l_(e){return $g(e).getComputedStyle(e)}function u_(e){if(Qg(e)===`html`)return e;let t=e.assignedSlot||e.parentNode||i_(e)&&e.host||e_(e);return i_(t)?t.host:t}Q();var d_=Zm[`useInsertionEffect${Math.random().toFixed(1)}`.slice(0,-3)],f_=d_&&d_!==Ce?d_:e=>e();function p_(e){let t=rg(m_).current;return t.next=e,f_(t.effect),t.trampoline}function m_(){let e={next:void 0,callback:h_,trampoline:(...t)=>e.callback?.(...t),effect:()=>{e.callback=e.next}};return e}function h_(){}Q();var g_={...Zm};Q();var __=typeof document<`u`?Ce:()=>{},v_=`trigger-press`,y_=`outside-press`,b_=`focus-out`,x_=`escape-key`,S_=`close-watcher`,C_=`imperative-action`;function w_(e,t,n,r){let i=!1,a=!1,o=r??Ag;return{reason:e,event:t??new Event(`base-ui`),cancel(){i=!0},allowPropagation(){a=!0},get isCanceled(){return i},get isPropagationAllowed(){return a},trigger:n,...o}}Q();var T_=0;function E_(e,t=`mui`){let[n,r]=H(e),i=e||n;return U(()=>{n??(T_+=1,r(`${t}-${T_}`))},[n,t]),i}var D_=g_.useId;function O_(e,t){if(D_!==void 0){let n=D_();return e??(t?`${t}-${n}`:n)}return E_(e,t)}Q();var k_=z(void 0);function A_(e){let t=Ee(k_);if(e===!1&&t===void 0)throw Error($h(91));return t}Q();var j_=[];function M_(e){U(e,j_)}var N_=0,P_=class e{static create(){return new e}currentId=N_;start(e,t){this.clear(),this.currentId=setTimeout(()=>{this.currentId=N_,t()},e)}isStarted(){return this.currentId!==N_}clear=()=>{this.currentId!==N_&&(clearTimeout(this.currentId),this.currentId=N_)};disposeEffect=()=>this.clear};function F_(){let e=rg(P_.create).current;return M_(e.disposeEffect),e}var I_=typeof navigator<`u`,L_=G_(),R_=q_(),z_=K_(),B_=typeof CSS>`u`||!CSS.supports?!1:CSS.supports(`-webkit-backdrop-filter:none`),V_=L_.platform===`MacIntel`&&L_.maxTouchPoints>1?!0:/iP(hone|ad|od)|iOS/.test(L_.platform);I_&&/firefox/i.test(z_);var H_=I_&&/apple/i.test(navigator.vendor);I_&&/Edg/i.test(z_);var U_=I_&&/android/i.test(R_)||/android/i.test(z_);I_&&R_.toLowerCase().startsWith(`mac`)&&navigator.maxTouchPoints;var W_=z_.includes(`jsdom/`);function G_(){if(!I_)return{platform:``,maxTouchPoints:-1};let e=navigator.userAgentData;return e?.platform?{platform:e.platform,maxTouchPoints:navigator.maxTouchPoints}:{platform:navigator.platform??``,maxTouchPoints:navigator.maxTouchPoints??-1}}function K_(){if(!I_)return``;let e=navigator.userAgentData;return e&&Array.isArray(e.brands)?e.brands.map(({brand:e,version:t})=>`${e}/${t}`).join(` `):navigator.userAgent}function q_(){if(!I_)return``;let e=navigator.userAgentData;return e?.platform?e.platform:navigator.platform??``}var J_=`data-base-ui-focusable`;function Y_(e){let t=e.activeElement;for(;t?.shadowRoot?.activeElement!=null;)t=t.shadowRoot.activeElement;return t}function X_(e,t){if(!e||!t)return!1;let n=t.getRootNode?.();if(e.contains(t))return!0;if(n&&i_(n)){let n=t;for(;n;){if(e===n)return!0;n=n.parentNode||n.host}}return!1}function Z_(e){return`composedPath`in e?e.composedPath()[0]:e.target}function Q_(e,t){if(t==null)return!1;if(`composedPath`in e)return e.composedPath().includes(t);let n=e;return n.target!=null&&t.contains(n.target)}function $_(e){return e.matches(`html,body`)}function ev(e){return r_(e)&&e.matches(`input:not([type='hidden']):not([disabled]),[contenteditable]:not([contenteditable='false']),textarea:not([disabled])`)}function tv(e){return e?e.getAttribute(`role`)===`combobox`&&ev(e):!1}function nv(e){return e?e.hasAttribute(`data-base-ui-focusable`)?e:e.querySelector(`[data-base-ui-focusable]`)||e:null}function rv(e,t,n=!0){return e.filter(e=>e.parentId===t&&(!n||e.context?.open)).flatMap(t=>[t,...rv(e,t.id,n)])}function iv(e,t){let n=[],r=e.find(e=>e.id===t)?.parentId;for(;r;){let t=e.find(e=>e.id===r);r=t?.parentId,t&&(n=n.concat(t))}return n}function av(e){e.preventDefault(),e.stopPropagation()}function ov(e){return`nativeEvent`in e}function sv(e){return e.pointerType===``&&e.isTrusted?!0:U_&&e.pointerType?e.type===`click`&&e.buttons===1:e.detail===0&&!e.pointerType}function cv(e){return W_?!1:!U_&&e.width===0&&e.height===0||U_&&e.width===1&&e.height===1&&e.pressure===0&&e.detail===0&&e.pointerType===`mouse`||e.width<1&&e.height<1&&e.pressure===0&&e.detail===0&&e.pointerType===`touch`}function lv(e){let t=e.type;return t===`click`||t===`mousedown`||t===`keydown`||t===`keyup`}function uv(e){return l_(e).display!==`none`}var dv=[`input:not([inert]):not([inert] *)`,`select:not([inert]):not([inert] *)`,`textarea:not([inert]):not([inert] *)`,`a[href]:not([inert]):not([inert] *)`,`button:not([inert]):not([inert] *)`,`[tabindex]:not(slot):not([inert]):not([inert] *)`,`audio[controls]:not([inert]):not([inert] *)`,`video[controls]:not([inert]):not([inert] *)`,`[contenteditable]:not([contenteditable="false"]):not([inert]):not([inert] *)`,`details>summary:first-of-type:not([inert]):not([inert] *)`,`details:not([inert]):not([inert] *)`].join(`,`),fv=typeof Element>`u`,pv=fv?function(){}:Element.prototype.matches||Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector,mv=!fv&&Element.prototype.getRootNode?function(e){return e?.getRootNode?.call(e)}:function(e){return e?.ownerDocument},hv=function(e,t){t===void 0&&(t=!0);var n=e?.getAttribute?.call(e,`inert`);return n===``||n===`true`||t&&e&&(typeof e.closest==`function`?e.closest(`[inert]`):hv(e.parentNode))},gv=function(e){var t=e?.getAttribute?.call(e,`contenteditable`);return t===``||t===`true`},_v=function(e,t,n){if(hv(e))return[];var r=Array.prototype.slice.apply(e.querySelectorAll(dv));return t&&pv.call(e,dv)&&r.unshift(e),r=r.filter(n),r},vv=function(e,t,n){for(var r=[],i=Array.from(e);i.length;){var a=i.shift();if(!hv(a,!1))if(a.tagName===`SLOT`){var o=a.assignedElements(),s=vv(o.length?o:a.children,!0,n);n.flatten?r.push.apply(r,s):r.push({scopeParent:a,candidates:s})}else{pv.call(a,dv)&&n.filter(a)&&(t||!e.includes(a))&&r.push(a);var c=a.shadowRoot||typeof n.getShadowRoot==`function`&&n.getShadowRoot(a),l=!hv(c,!1)&&(!n.shadowRootFilter||n.shadowRootFilter(a));if(c&&l){var u=vv(c===!0?a.children:c.children,!0,n);n.flatten?r.push.apply(r,u):r.push({scopeParent:a,candidates:u})}else i.unshift.apply(i,a.children)}}return r},yv=function(e){return!isNaN(parseInt(e.getAttribute(`tabindex`),10))},bv=function(e){if(!e)throw Error(`No node provided`);return e.tabIndex<0&&(/^(AUDIO|VIDEO|DETAILS)$/.test(e.tagName)||gv(e))&&!yv(e)?0:e.tabIndex},xv=function(e,t){var n=bv(e);return n<0&&t&&!yv(e)?0:n},Sv=function(e,t){return e.tabIndex===t.tabIndex?e.documentOrder-t.documentOrder:e.tabIndex-t.tabIndex},Cv=function(e){return e.tagName===`INPUT`},wv=function(e){return Cv(e)&&e.type===`hidden`},Tv=function(e){return e.tagName===`DETAILS`&&Array.prototype.slice.apply(e.children).some(function(e){return e.tagName===`SUMMARY`})},Ev=function(e,t){for(var n=0;n<e.length;n++)if(e[n].checked&&e[n].form===t)return e[n]},Dv=function(e){if(!e.name)return!0;var t=e.form||mv(e),n=function(e){return t.querySelectorAll(`input[type="radio"][name="`+e+`"]`)},r;if(typeof window<`u`&&window.CSS!==void 0&&typeof window.CSS.escape==`function`)r=n(window.CSS.escape(e.name));else try{r=n(e.name)}catch(e){return console.error(`Looks like you have a radio button with a name attribute containing invalid CSS selector characters and need the CSS.escape polyfill: %s`,e.message),!1}var i=Ev(r,e.form);return!i||i===e},Ov=function(e){return Cv(e)&&e.type===`radio`},kv=function(e){return Ov(e)&&!Dv(e)},Av=function(e){var t=e&&mv(e),n=t?.host,r=!1;if(t&&t!==e){var i,a,o;for(r=!!((i=n)!=null&&(a=i.ownerDocument)!=null&&a.contains(n)||e!=null&&(o=e.ownerDocument)!=null&&o.contains(e));!r&&n;){var s,c;t=mv(n),n=t?.host,r=!!((s=n)!=null&&(c=s.ownerDocument)!=null&&c.contains(n))}}return r},jv=function(e){var t=e.getBoundingClientRect(),n=t.width,r=t.height;return n===0&&r===0},Mv=function(e,t){var n=t.displayCheck,r=t.getShadowRoot;if(n===`full-native`&&`checkVisibility`in e)return!e.checkVisibility({checkOpacity:!1,opacityProperty:!1,contentVisibilityAuto:!0,visibilityProperty:!0,checkVisibilityCSS:!0});if(getComputedStyle(e).visibility===`hidden`)return!0;var i=pv.call(e,`details>summary:first-of-type`)?e.parentElement:e;if(pv.call(i,`details:not([open]) *`))return!0;if(!n||n===`full`||n===`full-native`||n===`legacy-full`){if(typeof r==`function`){for(var a=e;e;){var o=e.parentElement,s=mv(e);if(o&&!o.shadowRoot&&r(o)===!0)return jv(e);e=e.assignedSlot?e.assignedSlot:!o&&s!==e.ownerDocument?s.host:o}e=a}if(Av(e))return!e.getClientRects().length;if(n!==`legacy-full`)return!0}else if(n===`non-zero-area`)return jv(e);return!1},Nv=function(e){if(/^(INPUT|BUTTON|SELECT|TEXTAREA)$/.test(e.tagName))for(var t=e.parentElement;t;){if(t.tagName===`FIELDSET`&&t.disabled){for(var n=0;n<t.children.length;n++){var r=t.children.item(n);if(r.tagName===`LEGEND`)return pv.call(t,`fieldset[disabled] *`)?!0:!r.contains(e)}return!0}t=t.parentElement}return!1},Pv=function(e,t){return!(t.disabled||wv(t)||Mv(t,e)||Tv(t)||Nv(t))},Fv=function(e,t){return!(kv(t)||bv(t)<0||!Pv(e,t))},Iv=function(e){var t=parseInt(e.getAttribute(`tabindex`),10);return!!(isNaN(t)||t>=0)},Lv=function(e){var t=[],n=[];return e.forEach(function(e,r){var i=!!e.scopeParent,a=i?e.scopeParent:e,o=xv(a,i),s=i?Lv(e.candidates):a;o===0?i?t.push.apply(t,s):t.push(a):n.push({documentOrder:r,tabIndex:o,item:e,isScope:i,content:s})}),n.sort(Sv).reduce(function(e,t){return t.isScope?e.push.apply(e,t.content):e.push(t.content),e},[]).concat(t)},Rv=function(e,t){return t||={},Lv(t.getShadowRoot?vv([e],t.includeContainer,{filter:Fv.bind(null,t),flatten:!1,getShadowRoot:t.getShadowRoot,shadowRootFilter:Iv}):_v(e,t.includeContainer,Fv.bind(null,t)))},zv=function(e,t){return t||={},t.getShadowRoot?vv([e],t.includeContainer,{filter:Pv.bind(null,t),flatten:!0,getShadowRoot:t.getShadowRoot}):_v(e,t.includeContainer,Pv.bind(null,t))},Bv=function(e,t){if(t||={},!e)throw Error(`No node provided`);return pv.call(e,dv)===!1?!1:Fv(t,e)};function Vv(e){return e?.ownerDocument||document}var Hv=()=>({getShadowRoot:!0,displayCheck:typeof ResizeObserver==`function`&&ResizeObserver.toString().includes(`[native code]`)?`full`:`none`});function Uv(e,t){let n=Rv(e,Hv()),r=n.length;if(r===0)return;let i=Y_(Vv(e)),a=n.indexOf(i);return n[a===-1?t===1?0:r-1:a+t]}function Wv(e){return Uv(Vv(e).body,1)||e}function Gv(e){return Uv(Vv(e).body,-1)||e}function Kv(e,t){let n=t||e.currentTarget,r=e.relatedTarget;return!r||!X_(n,r)}function qv(e){Rv(e,Hv()).forEach(e=>{e.dataset.tabindex=e.getAttribute(`tabindex`)||``,e.setAttribute(`tabindex`,`-1`)})}function Jv(e){e.querySelectorAll(`[data-tabindex]`).forEach(e=>{let t=e.dataset.tabindex;delete e.dataset.tabindex,t?e.setAttribute(`tabindex`,t):e.removeAttribute(`tabindex`)})}be();var Yv=0;Array.isArray;function $(e,t,n,r,i,a){t||={};var o,s,c=t;if(`ref`in c)for(s in c={},t)s==`ref`?o=t[s]:c[s]=t[s];var l={type:e,props:c,key:n,ref:o,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:--Yv,__i:-1,__u:0,__source:i,__self:a};if(typeof e==`function`&&(o=e.defaultProps))for(s in o)c[s]===void 0&&(c[s]=o[s]);return V.vnode&&V.vnode(l),l}function Xv(e){let t=rg(Zv,e).current;return t.next=e,__(t.effect),t}function Zv(e){let t={current:e,next:e,effect:()=>{t.current=t.next}};return t}var Qv=null;globalThis.requestAnimationFrame;var $v=new class{callbacks=[];callbacksCount=0;nextId=1;startId=1;isScheduled=!1;tick=e=>{this.isScheduled=!1;let t=this.callbacks,n=this.callbacksCount;if(this.callbacks=[],this.callbacksCount=0,this.startId=this.nextId,n>0)for(let n=0;n<t.length;n+=1)t[n]?.(e)};request(e){let t=this.nextId;return this.nextId+=1,this.callbacks.push(e),this.callbacksCount+=1,this.isScheduled||=(requestAnimationFrame(this.tick),!0),t}cancel(e){let t=e-this.startId;t<0||t>=this.callbacks.length||(this.callbacks[t]=null,--this.callbacksCount)}},ey=class e{static create(){return new e}static request(e){return $v.request(e)}static cancel(e){return $v.cancel(e)}currentId=Qv;request(e){this.cancel(),this.currentId=$v.request(()=>{this.currentId=Qv,e()})}cancel=()=>{this.currentId!==Qv&&($v.cancel(this.currentId),this.currentId=Qv)};disposeEffect=()=>this.cancel};function ty(){let e=rg(ey.create).current;return M_(e.disposeEffect),e}var ny={clipPath:`inset(50%)`,overflow:`hidden`,whiteSpace:`nowrap`,border:0,padding:0,width:1,height:1,margin:-1},ry={...ny,position:`fixed`,top:0,left:0};({...ny}),Q();var iy=sh(function(e,t){let[n,r]=H();__(()=>{H_&&r(`button`)},[]);let i={tabIndex:0,role:n};return $(`span`,{...e,ref:t,style:ry,"aria-hidden":n?void 0:!0,...i,"data-base-ui-focus-guard":``})});function ay(e){return`data-base-ui-${e}`}var oy=0;function sy(e,t={}){let{preventScroll:n=!1,cancelPrevious:r=!0,sync:i=!1}=t;r&&cancelAnimationFrame(oy);let a=()=>e?.focus({preventScroll:n});i?a():oy=requestAnimationFrame(a)}var cy={inert:new WeakMap,"aria-hidden":new WeakMap},ly=`data-base-ui-inert`,uy={inert:new WeakSet,"aria-hidden":new WeakSet},dy=new WeakMap,fy=0;function py(e){return uy[e]}function my(e){return e?i_(e)?e.host:my(e.parentNode):null}var hy=(e,t)=>t.map(t=>{if(e.contains(t))return t;let n=my(t);return e.contains(n)?n:null}).filter(e=>e!=null),gy=e=>{let t=new Set;return e.forEach(e=>{let n=e;for(;n&&!t.has(n);)t.add(n),n=n.parentNode}),t},_y=(e,t,n)=>{let r=[],i=e=>{!e||n.has(e)||Array.from(e.children).forEach(e=>{Qg(e)!==`script`&&(t.has(e)?i(e):r.push(e))})};return i(e),r};function vy(e,t,n,r,{mark:i=!0,markerIgnoreElements:a=[]}){let o=r?`inert`:n?`aria-hidden`:null,s=null,c=null,l=hy(t,e),u=i?hy(t,a):[],d=new Set(u),f=i?_y(t,gy(l),new Set(l)).filter(e=>!d.has(e)):[],p=[],m=[];if(o){let e=cy[o],n=py(o);c=n,s=e;let r=hy(t,Array.from(t.querySelectorAll(`[aria-live]`))),i=l.concat(r);_y(t,gy(i),new Set(i)).forEach(t=>{let r=t.getAttribute(o),i=r!==null&&r!==`false`,a=(e.get(t)||0)+1;e.set(t,a),p.push(t),a===1&&i&&n.add(t),i||t.setAttribute(o,o===`inert`?``:`true`)})}return i&&f.forEach(e=>{let t=(dy.get(e)||0)+1;dy.set(e,t),m.push(e),t===1&&e.setAttribute(ly,``)}),fy+=1,()=>{s&&p.forEach(e=>{let t=(s.get(e)||0)-1;s.set(e,t),t||(!c?.has(e)&&o&&e.removeAttribute(o),c?.delete(e))}),i&&m.forEach(e=>{let t=(dy.get(e)||0)-1;dy.set(e,t),t||e.removeAttribute(ly)}),--fy,fy||(cy.inert=new WeakMap,cy[`aria-hidden`]=new WeakMap,uy.inert=new WeakSet,uy[`aria-hidden`]=new WeakSet,dy=new WeakMap)}}function yy(e,t={}){let{ariaHidden:n=!1,inert:r=!1,mark:i=!0,markerIgnoreElements:a=[]}=t,o=Vv(e[0]).body;return vy(e,o,n,r,{mark:i,markerIgnoreElements:a})}Q();var by=z(null),xy=()=>Ee(by),Sy=ay(`portal`);function Cy(e={}){let{ref:t,container:n,componentProps:r=Ag,elementProps:i}=e,a=O_(),o=xy()?.portalNode,[s,c]=H(null),[l,u]=H(null),d=p_(e=>{e!==null&&u(e)}),f=W(null);__(()=>{if(n===null){f.current&&(f.current=null,u(null),c(null));return}if(a==null)return;let e=(n&&(t_(n)?n:n.current))??o??document.body;if(e==null){f.current&&(f.current=null,u(null),c(null));return}f.current!==e&&(f.current=e,u(null),c(e))},[n,o,a]);let p=Mg(`div`,r,{ref:[t,d],props:[{id:a,[Sy]:``},i]});return{portalNode:l,portalSubtree:s&&p?gh(p,s):null}}var wy=sh(function(e,t){let{children:n,container:r,className:i,render:a,renderGuards:o,...s}=e,{portalNode:c,portalSubtree:l}=Cy({container:r,ref:t,componentProps:e,elementProps:s}),u=W(null),d=W(null),f=W(null),p=W(null),[m,h]=H(null),g=m?.modal,_=m?.open,y=typeof o==`boolean`?o:!!m&&!m.modal&&m.open&&!!c;U(()=>{if(!c||g)return;function e(e){c&&e.relatedTarget&&Kv(e)&&(e.type===`focusin`?Jv:qv)(c)}return c.addEventListener(`focusin`,e,!0),c.addEventListener(`focusout`,e,!0),()=>{c.removeEventListener(`focusin`,e,!0),c.removeEventListener(`focusout`,e,!0)}},[c,g]),U(()=>{!c||_||Jv(c)},[_,c]);let b=G(()=>({beforeOutsideRef:u,afterOutsideRef:d,beforeInsideRef:f,afterInsideRef:p,portalNode:c,setFocusManagerState:h}),[c]);return $(v,{children:[l,$(by.Provider,{value:b,children:[y&&c&&$(iy,{"data-type":`outside`,ref:u,onFocus:e=>{Kv(e,c)?f.current?.focus():Gv(m?m.domReference:null)?.focus()}}),y&&c&&$(`span`,{"aria-owns":c.id,style:jg}),c&&gh(n,c),y&&c&&$(iy,{"data-type":`outside`,ref:d,onFocus:e=>{Kv(e,c)?p.current?.focus():(Wv(m?m.domReference:null)?.focus(),m?.closeOnFocusOut&&m?.onOpenChange(!1,w_(`focus-out`,e.nativeEvent)))}})]})]})});function Ty(){let e=new Map;return{emit(t,n){e.get(t)?.forEach(e=>e(n))},on(t,n){e.has(t)||e.set(t,new Set),e.get(t).add(n)},off(t,n){e.get(t)?.delete(n)}}}Q();var Ey=z(null),Dy=z(null),Oy=()=>Ee(Ey)?.id||null,ky=e=>{let t=Ee(Dy);return e??t};function Ay(e){return e==null?e:`current`in e?e.current:e}Q();function jy(e,t){let n=$g(e.target);return e instanceof n.KeyboardEvent?`keyboard`:e instanceof n.FocusEvent?t||`keyboard`:`pointerType`in e?e.pointerType||`keyboard`:`touches`in e?`touch`:e instanceof n.MouseEvent?t||(e.detail===0?`keyboard`:`mouse`):``}var My=20,Ny=[];function Py(){Ny=Ny.filter(e=>e.deref()?.isConnected)}function Fy(e){Py(),e&&Qg(e)!==`body`&&(Ny.push(new WeakRef(e)),Ny.length>My&&(Ny=Ny.slice(-My)))}function Iy(){return Py(),Ny[Ny.length-1]?.deref()}function Ly(e){if(!e)return null;let t=Hv();return Bv(e,t)?e:Rv(e,t)[0]||e}function Ry(e){return!e||!e.isConnected?!1:typeof e.checkVisibility==`function`?e.checkVisibility():uv(e)}function zy(e,t){if(!t.current.includes(`floating`)&&!e.getAttribute(`role`)?.includes(`dialog`))return;let n=Hv(),r=zv(e,n).filter(e=>{let t=e.getAttribute(`data-tabindex`)||``;return Bv(e,n)||e.hasAttribute(`data-tabindex`)&&!t.startsWith(`-`)}),i=e.getAttribute(`tabindex`);t.current.includes(`floating`)||r.length===0?i!==`0`&&e.setAttribute(`tabindex`,`0`):(i!==`-1`||e.hasAttribute(`data-tabindex`)&&e.getAttribute(`data-tabindex`)!==`-1`)&&(e.setAttribute(`tabindex`,`-1`),e.setAttribute(`data-tabindex`,`-1`))}function By(e){let{context:t,children:n,disabled:r=!1,initialFocus:i=!0,returnFocus:a=!0,restoreFocus:o=!1,modal:s=!0,closeOnFocusOut:c=!0,openInteractionType:l=``,nextFocusableElement:u,previousFocusableElement:d,beforeContentFocusGuardRef:f,externalTree:p,getInsideElements:m}=e,h=`rootStore`in t?t.rootStore:t,g=h.useState(`open`),_=h.useState(`domReferenceElement`),y=h.useState(`floatingElement`),{events:b,dataRef:x}=h.context,S=p_(()=>x.current.floatingContext?.nodeId),C=i===!1,w=tv(_)&&C,T=W([`content`]),E=Xv(i),D=Xv(a),O=Xv(l),k=ky(p),A=xy(),j=W(!1),M=W(!1),ee=W(!1),N=W(-1),P=W(``),te=W(``),ne=W(null),F=W(null),I=ig(ne,f,A?.beforeInsideRef),L=ig(F,A?.afterInsideRef),R=F_(),re=F_(),ie=ty(),z=A!=null,B=nv(y),V=p_((e=B)=>e?Rv(e,Hv()):[]),ae=p_(()=>m?.().filter(e=>e!=null)??[]),oe=p_(e=>{let t=V(e);return T.current.map(()=>t).filter(Boolean).flat()});U(()=>{if(r||!s)return;function e(e){e.key===`Tab`&&X_(B,Y_(Vv(B)))&&V().length===0&&!w&&av(e)}let t=Vv(B);return t.addEventListener(`keydown`,e),()=>{t.removeEventListener(`keydown`,e)}},[r,_,B,s,T,w,V,oe]),U(()=>{if(r||!g)return;let e=Vv(B);function t(){ee.current=!1}function n(e){let t=Z_(e),n=ae();ee.current=!(X_(y,t)||X_(_,t)||X_(A?.portalNode,t)||n.some(e=>e===t||X_(e,t))),te.current=e.pointerType||`keyboard`,t?.closest(`[data-base-ui-click-trigger]`)&&(M.current=!0)}function i(){te.current=`keyboard`}return e.addEventListener(`pointerdown`,n,!0),e.addEventListener(`pointerup`,t,!0),e.addEventListener(`pointercancel`,t,!0),e.addEventListener(`keydown`,i,!0),()=>{e.removeEventListener(`pointerdown`,n,!0),e.removeEventListener(`pointerup`,t,!0),e.removeEventListener(`pointercancel`,t,!0),e.removeEventListener(`keydown`,i,!0)}},[r,y,_,B,g,A,ae]),U(()=>{if(r||!c)return;let e=Vv(B);function t(){M.current=!0,re.start(0,()=>{M.current=!1})}function n(e){let t=Z_(e),n=V().indexOf(t);n!==-1&&(N.current=n)}function i(t){let n=t.relatedTarget,r=t.currentTarget,i=Z_(t);queueMicrotask(()=>{let a=S(),c=h.context.triggerElements,l=ae(),f=n?.hasAttribute(ay(`focus-guard`))&&[ne.current,F.current,A?.beforeInsideRef.current,A?.afterInsideRef.current,A?.beforeOutsideRef.current,A?.afterOutsideRef.current,Ay(d),Ay(u)].includes(n),p=!(X_(_,n)||X_(y,n)||X_(n,y)||X_(A?.portalNode,n)||l.some(e=>e===n||X_(e,n))||n!=null&&c.hasElement(n)||c.hasMatchingElement(e=>X_(e,n))||f||k&&(rv(k.nodesRef.current,a).find(e=>X_(e.context?.elements.floating,n)||X_(e.context?.elements.domReference,n))||iv(k.nodesRef.current,a).find(e=>[e.context?.elements.floating,nv(e.context?.elements.floating)].includes(n)||e.context?.elements.domReference===n)));if(r===_&&B&&zy(B,T),o&&r!==_&&!Ry(i)&&Y_(e)===e.body){if(r_(B)&&(B.focus(),o===`popup`)){ie.request(()=>{B.focus()});return}let e=N.current,t=V(),n=t[e]||t[t.length-1]||B;r_(n)&&n.focus()}if(x.current.insideReactTree){x.current.insideReactTree=!1;return}(w||!s)&&n&&p&&!M.current&&(w||n!==Iy())&&(j.current=!0,h.setOpen(!1,w_(b_,t)))})}function a(){ee.current||(x.current.insideReactTree=!0,R.start(0,()=>{x.current.insideReactTree=!1}))}let l=r_(_)?_:null,f=[];if(!(!y&&!l))return l&&(l.addEventListener(`focusout`,i),l.addEventListener(`pointerdown`,t),f.push(()=>{l.removeEventListener(`focusout`,i),l.removeEventListener(`pointerdown`,t)})),y&&(y.addEventListener(`focusin`,n),y.addEventListener(`focusout`,i),A&&(y.addEventListener(`focusout`,a,!0),f.push(()=>{y.removeEventListener(`focusout`,a,!0)})),f.push(()=>{y.removeEventListener(`focusin`,n),y.removeEventListener(`focusout`,i)})),()=>{f.forEach(e=>{e()})}},[r,_,y,B,s,k,A,h,c,o,V,w,S,T,x,R,re,ie,u,d,ae]),U(()=>{if(r||!y||!g)return;let e=Array.from(A?.portalNode?.querySelectorAll(`[${ay(`portal`)}]`)||[]),t=(k?iv(k.nodesRef.current,S()):[]).find(e=>tv(e.context?.elements.domReference||null))?.context?.elements.domReference,n=yy([...[y,...e,ne.current,F.current,A?.beforeOutsideRef.current,A?.afterOutsideRef.current,...ae()],t,Ay(d),Ay(u),w?_:null].filter(e=>e!=null),{ariaHidden:s||w,mark:!1}),i=yy([y,...e].filter(e=>e!=null));return()=>{i(),n()}},[g,r,_,y,s,T,A,w,k,S,u,d,ae]),__(()=>{if(!g||r||!r_(B))return;let e=Y_(Vv(B));queueMicrotask(()=>{let t=oe(B),n=E.current,r=typeof n==`function`?n(O.current||``):n;if(r===void 0||r===!1)return;let i;i=r===!0||r===null?t[0]||B:Ay(r),i=i||t[0]||B,!X_(B,e)&&sy(i,{preventScroll:i===B})})},[r,g,B,C,oe,E,O]),__(()=>{if(r||!B)return;let e=Vv(B);Fy(Y_(e));function t(e){if(e.open||(P.current=jy(e.nativeEvent,te.current)),e.reason===`trigger-hover`&&e.nativeEvent.type===`mouseleave`&&(j.current=!0),e.reason===`outside-press`)if(e.nested)j.current=!1;else if(sv(e.nativeEvent)||cv(e.nativeEvent))j.current=!1;else{let e=!1;document.createElement(`div`).focus({get preventScroll(){return e=!0,!1}}),e?j.current=!1:j.current=!0}}b.on(`openchange`,t);function n(){let e=D.current,t=typeof e==`function`?e(P.current):e;if(t===void 0||t===!1)return null;if(t===null&&(t=!0),typeof t==`boolean`){let e=_||Iy();return e&&e.isConnected?e:null}let n=_||Iy();return Ay(t)||n||null}return()=>{b.off(`openchange`,t);let r=Y_(e),i=ae(),a=X_(y,r)||i.some(e=>e===r||X_(e,r))||k&&rv(k.nodesRef.current,S(),!1).some(e=>X_(e.context?.elements.floating,r)),o=n();queueMicrotask(()=>{let t=Ly(o),n=typeof D.current!=`boolean`;D.current&&!j.current&&r_(t)&&(!(!n&&t!==r&&r!==e.body)||a)&&t.focus({preventScroll:!0}),j.current=!1})}},[r,y,B,D,x,b,k,_,S,ae]),__(()=>{if(!B_||g||!y)return;let e=Y_(Vv(y));!r_(e)||!ev(e)||X_(y,e)&&e.blur()},[g,y]),__(()=>{if(!(r||!A))return A.setFocusManagerState({modal:s,closeOnFocusOut:c,open:g,onOpenChange:h.setOpen,domReference:_}),()=>{A.setFocusManagerState(null)}},[r,A,s,g,h,c,_]),__(()=>{if(!(r||!B))return zy(B,T),()=>{queueMicrotask(Py)}},[r,B,T]);let se=!r&&(s?!w:!0)&&(z||s);return $(v,{children:[se&&$(iy,{"data-type":`inside`,ref:I,onFocus:e=>{if(s){let e=oe();sy(e[e.length-1])}else A?.portalNode&&(j.current=!1,Kv(e,A.portalNode)?Wv(_)?.focus():Ay(d??A.beforeOutsideRef)?.focus())}}),n,se&&$(iy,{"data-type":`inside`,ref:L,onFocus:e=>{s?sy(oe()[0]):A?.portalNode&&(c&&(j.current=!0),Kv(e,A.portalNode)?Gv(_)?.focus():Ay(u??A.afterOutsideRef)?.focus())}})]})}Q();var Vy={intentional:`onClick`,sloppy:`onPointerDown`};function Hy(){return!1}function Uy(e){return{escapeKey:typeof e==`boolean`?e:e?.escapeKey??!1,outsidePress:typeof e==`boolean`?e:e?.outsidePress??!0}}function Wy(e,t={}){let n=`rootStore`in e?e.rootStore:e,r=n.useState(`open`),i=n.useState(`floatingElement`),{dataRef:a}=n.context,{enabled:o=!0,escapeKey:s=!0,outsidePress:c=!0,outsidePressEvent:l=`sloppy`,referencePress:u=Hy,referencePressEvent:d=`sloppy`,bubbles:f,externalTree:p}=t,m=ky(p),h=p_(typeof c==`function`?c:()=>!1),g=typeof c==`function`?h:c,_=g!==!1,v=p_(()=>l),y=W(!1),b=W(!1),x=W(!1),{escapeKey:S,outsidePress:C}=Uy(f),w=W(null),T=F_(),E=F_(),D=p_(()=>{E.clear(),a.current.insideReactTree=!1}),O=W(!1),k=W(``),A=p_(u),j=p_(e=>{if(!r||!o||!s||e.key!==`Escape`||O.current)return;let t=a.current.floatingContext?.nodeId,i=m?rv(m.nodesRef.current,t):[];if(!S&&i.length>0){let e=!0;if(i.forEach(t=>{t.context?.open&&!t.context.dataRef.current.__escapeKeyBubbles&&(e=!1)}),!e)return}let c=w_(x_,ov(e)?e.nativeEvent:e);n.setOpen(!1,c),!S&&!c.isPropagationAllowed&&e.stopPropagation()}),M=p_(()=>{a.current.insideReactTree=!0,E.start(0,D)});U(()=>{if(!r||!o)return;a.current.__escapeKeyBubbles=S,a.current.__outsidePressBubbles=C;let e=new P_,t=new P_;function c(){e.clear(),O.current=!0}function l(){e.start(s_()?5:0,()=>{O.current=!1})}function u(){x.current=!0,t.start(0,()=>{x.current=!1})}function d(){y.current=!1,b.current=!1}function f(){let e=k.current,t=e===`pen`||!e?`mouse`:e,n=v(),r=typeof n==`function`?n():n;return typeof r==`string`?r:r[t]}function p(e){let t=f();return t===`intentional`&&e.type!==`click`||t===`sloppy`&&e.type===`click`}function h(e){let t=a.current.floatingContext?.nodeId,r=m&&rv(m.nodesRef.current,t).some(t=>Q_(e,t.context?.elements.floating));return Q_(e,n.select(`floatingElement`))||Q_(e,n.select(`domReferenceElement`))||r}function E(e){if(p(e)){D();return}if(a.current.insideReactTree){D();return}let r=Z_(e),i=`[${ay(`inert`)}]`,o=Array.from(Vv(n.select(`floatingElement`)).querySelectorAll(i)),s=n_(r)?r.getRootNode():null;i_(s)&&(o=o.concat(Array.from(s.querySelectorAll(i))));let c=n.context.triggerElements;if(r&&(c.hasElement(r)||c.hasMatchingElement(e=>X_(e,r))))return;let l=n_(r)?r:null;for(;l&&!c_(l);){let e=u_(l);if(c_(e)||!n_(e))break;l=e}if(o.length&&n_(r)&&!$_(r)&&!X_(r,n.select(`floatingElement`))&&o.every(e=>!X_(l,e)))return;if(r_(r)&&!(`touches`in e)){let t=c_(r),n=l_(r),i=/auto|scroll/,a=t||i.test(n.overflowX),o=t||i.test(n.overflowY),s=a&&r.clientWidth>0&&r.scrollWidth>r.clientWidth,c=o&&r.clientHeight>0&&r.scrollHeight>r.clientHeight,l=n.direction===`rtl`,u=c&&(l?e.offsetX<=r.offsetWidth-r.clientWidth:e.offsetX>r.clientWidth),d=s&&e.offsetY>r.clientHeight;if(u||d)return}if(h(e))return;if(f()===`intentional`&&x.current){t.clear(),x.current=!1;return}if(typeof g==`function`&&!g(e))return;let u=a.current.floatingContext?.nodeId,d=m?rv(m.nodesRef.current,u):[];if(d.length>0){let e=!0;if(d.forEach(t=>{t.context?.open&&!t.context.dataRef.current.__outsidePressBubbles&&(e=!1)}),!e)return}n.setOpen(!1,w_(y_,e)),D()}function A(e){f()!==`sloppy`||e.pointerType===`touch`||!n.select(`open`)||!o||Q_(e,n.select(`floatingElement`))||Q_(e,n.select(`domReferenceElement`))||E(e)}function M(e){if(f()!==`sloppy`||!n.select(`open`)||!o||Q_(e,n.select(`floatingElement`))||Q_(e,n.select(`domReferenceElement`)))return;let t=e.touches[0];t&&(w.current={startTime:Date.now(),startX:t.clientX,startY:t.clientY,dismissOnTouchEnd:!1,dismissOnMouseDown:!0},T.start(1e3,()=>{w.current&&(w.current.dismissOnTouchEnd=!1,w.current.dismissOnMouseDown=!1)}))}function ee(e){k.current=`touch`;let t=Z_(e);function n(){M(e),t?.removeEventListener(e.type,n)}t?.addEventListener(e.type,n)}function N(e){if(T.clear(),e.type===`pointerdown`&&(k.current=e.pointerType),e.type===`mousedown`&&w.current&&!w.current.dismissOnMouseDown)return;let t=Z_(e);function n(){e.type===`pointerdown`?A(e):E(e),t?.removeEventListener(e.type,n)}t?.addEventListener(e.type,n)}function P(e){if(!y.current)return;let n=b.current;if(d(),f()===`intentional`){if(e.type===`pointercancel`){n&&u();return}if(!h(e)){if(n){u();return}typeof g==`function`&&!g(e)||(t.clear(),x.current=!0,D())}}}function te(e){if(f()!==`sloppy`||!w.current||Q_(e,n.select(`floatingElement`))||Q_(e,n.select(`domReferenceElement`)))return;let t=e.touches[0];if(!t)return;let r=Math.abs(t.clientX-w.current.startX),i=Math.abs(t.clientY-w.current.startY),a=Math.sqrt(r*r+i*i);a>5&&(w.current.dismissOnTouchEnd=!0),a>10&&(E(e),T.clear(),w.current=null)}function ne(e){let t=Z_(e);function n(){te(e),t?.removeEventListener(e.type,n)}t?.addEventListener(e.type,n)}function F(e){f()!==`sloppy`||!w.current||Q_(e,n.select(`floatingElement`))||Q_(e,n.select(`domReferenceElement`))||(w.current.dismissOnTouchEnd&&E(e),T.clear(),w.current=null)}function I(e){let t=Z_(e);function n(){F(e),t?.removeEventListener(e.type,n)}t?.addEventListener(e.type,n)}let L=Vv(i);return s&&(L.addEventListener(`keydown`,j),L.addEventListener(`compositionstart`,c),L.addEventListener(`compositionend`,l)),_&&(L.addEventListener(`click`,N,!0),L.addEventListener(`pointerdown`,N,!0),L.addEventListener(`pointerup`,P,!0),L.addEventListener(`pointercancel`,P,!0),L.addEventListener(`mousedown`,N,!0),L.addEventListener(`mouseup`,P,!0),L.addEventListener(`touchstart`,ee,!0),L.addEventListener(`touchmove`,ne,!0),L.addEventListener(`touchend`,I,!0)),()=>{s&&(L.removeEventListener(`keydown`,j),L.removeEventListener(`compositionstart`,c),L.removeEventListener(`compositionend`,l)),_&&(L.removeEventListener(`click`,N,!0),L.removeEventListener(`pointerdown`,N,!0),L.removeEventListener(`pointerup`,P,!0),L.removeEventListener(`pointercancel`,P,!0),L.removeEventListener(`mousedown`,N,!0),L.removeEventListener(`mouseup`,P,!0),L.removeEventListener(`touchstart`,ee,!0),L.removeEventListener(`touchmove`,ne,!0),L.removeEventListener(`touchend`,I,!0)),e.clear(),t.clear(),d(),x.current=!1}},[a,i,s,_,g,r,o,S,C,j,D,v,m,n,T]),U(D,[g,D]);let ee=G(()=>({onKeyDown:j,[Vy[d]]:e=>{A()&&n.setOpen(!1,w_(v_,e.nativeEvent))},...d!==`intentional`&&{onClick(e){A()&&n.setOpen(!1,w_(`trigger-press`,e.nativeEvent))}}}),[j,n,d,A]),N=p_(e=>{if(!r||!o||e.button!==0)return;let t=Z_(e.nativeEvent);X_(n.select(`floatingElement`),t)&&(y.current||(y.current=!0,b.current=!1))}),P=p_(e=>{!r||!o||(e.defaultPrevented||e.nativeEvent.defaultPrevented)&&y.current&&(b.current=!0)}),te=G(()=>({onKeyDown:j,onPointerDown:P,onMouseDown:P,onClickCapture:M,onMouseDownCapture(e){M(),N(e)},onPointerDownCapture(e){M(),N(e)},onMouseUpCapture:M,onTouchEndCapture:M,onTouchMoveCapture:M}),[j,M,N,P]);return G(()=>o?{reference:ee,floating:te,trigger:ee}:{},[o,ee,te])}var Gy=Symbol(`NOT_FOUND`);function Ky(e,t=`expected a function, instead received ${typeof e}`){if(typeof e!=`function`)throw TypeError(t)}function qy(e,t=`expected an object, instead received ${typeof e}`){if(typeof e!=`object`)throw TypeError(t)}function Jy(e,t=`expected all items to be functions, instead received the following types: `){if(!e.every(e=>typeof e==`function`)){let n=e.map(e=>typeof e==`function`?`function ${e.name||`unnamed`}()`:typeof e).join(`, `);throw TypeError(`${t}[${n}]`)}}var Yy=e=>Array.isArray(e)?e:[e];function Xy(e){let t=Array.isArray(e[0])?e[0]:e;return Jy(t,`createSelector expects all input-selectors to be functions, but received the following types: `),t}function Zy(e,t){let n=[],{length:r}=e;for(let i=0;i<r;i++)n.push(e[i].apply(null,t));return n}function Qy(e){let t;return{get(n){return t&&e(t.key,n)?t.value:Gy},put(e,n){t={key:e,value:n}},getEntries(){return t?[t]:[]},clear(){t=void 0}}}function $y(e,t){let n=[];function r(e){let r=n.findIndex(n=>t(e,n.key));if(r>-1){let e=n[r];return r>0&&(n.splice(r,1),n.unshift(e)),e.value}return Gy}function i(t,i){r(t)===Gy&&(n.unshift({key:t,value:i}),n.length>e&&n.pop())}function a(){return n}function o(){n=[]}return{get:r,put:i,getEntries:a,clear:o}}var eb=(e,t)=>e===t;function tb(e){return function(t,n){if(t===null||n===null||t.length!==n.length)return!1;let{length:r}=t;for(let i=0;i<r;i++)if(!e(t[i],n[i]))return!1;return!0}}function nb(e,t){let{equalityCheck:n=eb,maxSize:r=1,resultEqualityCheck:i}=typeof t==`object`?t:{equalityCheck:t},a=tb(n),o=0,s=r<=1?Qy(a):$y(r,a);function c(){let t=s.get(arguments);if(t===Gy){if(t=e.apply(null,arguments),o++,i){let e=s.getEntries().find(e=>i(e.value,t));e&&(t=e.value,o!==0&&o--)}s.put(arguments,t)}return t}return c.clearCache=()=>{s.clear(),c.resetResultsCount()},c.resultsCount=()=>o,c.resetResultsCount=()=>{o=0},c}var rb=class{constructor(e){this.value=e}deref(){return this.value}},ib=typeof WeakRef<`u`?WeakRef:rb,ab=0,ob=1;function sb(){return{s:ab,v:void 0,o:null,p:null}}function cb(e,t={}){let n=sb(),{resultEqualityCheck:r}=t,i,a=0;function o(){let t=n,{length:o}=arguments;for(let e=0,n=o;e<n;e++){let n=arguments[e];if(typeof n==`function`||typeof n==`object`&&n){let e=t.o;e===null&&(t.o=e=new WeakMap);let r=e.get(n);r===void 0?(t=sb(),e.set(n,t)):t=r}else{let e=t.p;e===null&&(t.p=e=new Map);let r=e.get(n);r===void 0?(t=sb(),e.set(n,t)):t=r}}let s=t,c;if(t.s===ob)c=t.v;else if(c=e.apply(null,arguments),a++,r){let e=i?.deref?.()??i;e!=null&&r(e,c)&&(c=e,a!==0&&a--),i=typeof c==`object`&&c||typeof c==`function`?new ib(c):c}return s.s=ob,s.v=c,c}return o.clearCache=()=>{n=sb(),o.resetResultsCount()},o.resultsCount=()=>a,o.resetResultsCount=()=>{a=0},o}function lb(e,...t){let n=typeof e==`function`?{memoize:e,memoizeOptions:t}:e,r=(...e)=>{let t=0,r=0,i,a={},o=e.pop();typeof o==`object`&&(a=o,o=e.pop()),Ky(o,`createSelector expects an output function after the inputs, but received: [${typeof o}]`);let{memoize:s,memoizeOptions:c=[],argsMemoize:l=cb,argsMemoizeOptions:u=[],devModeChecks:d={}}={...n,...a},f=Yy(c),p=Yy(u),m=Xy(e),h=s(function(){return t++,o.apply(null,arguments)},...f),g=l(function(){r++;let e=Zy(m,arguments);return i=h.apply(null,e),i},...p);return Object.assign(g,{resultFunc:o,memoizedResultFunc:h,dependencies:m,dependencyRecomputations:()=>r,resetDependencyRecomputations:()=>{r=0},lastResult:()=>i,recomputations:()=>t,resetRecomputations:()=>{t=0},memoize:s,argsMemoize:l})};return Object.assign(r,{withTypes:()=>r}),r}var ub=lb(cb),db=Object.assign((e,t=ub)=>{qy(e,`createStructuredSelector expects first argument to be an object where each property is a selector, instead received a ${typeof e}`);let n=Object.keys(e);return t(n.map(t=>e[t]),(...e)=>e.reduce((e,t,r)=>(e[n[r]]=t,e),{}))},{withTypes:()=>db});lb({memoize:nb,memoizeOptions:{maxSize:1,equalityCheck:Object.is}});var fb=(e,t,n,r,i,a,...o)=>{if(o.length>0)throw Error($h(1));let s;if(e&&t&&n&&r&&i&&a)s=(o,s,c,l)=>a(e(o,s,c,l),t(o,s,c,l),n(o,s,c,l),r(o,s,c,l),i(o,s,c,l),s,c,l);else if(e&&t&&n&&r&&i)s=(a,o,s,c)=>i(e(a,o,s,c),t(a,o,s,c),n(a,o,s,c),r(a,o,s,c),o,s,c);else if(e&&t&&n&&r)s=(i,a,o,s)=>r(e(i,a,o,s),t(i,a,o,s),n(i,a,o,s),a,o,s);else if(e&&t&&n)s=(r,i,a,o)=>n(e(r,i,a,o),t(r,i,a,o),i,a,o);else if(e&&t)s=(n,r,i,a)=>t(e(n,r,i,a),r,i,a);else if(e)s=e;else throw Error(`Missing arguments`);return s},pb=s((e=>{var t=(Q(),d(Zm));function n(e,t){return e===t&&(e!==0||1/e==1/t)||e!==e&&t!==t}var r=typeof Object.is==`function`?Object.is:n,i=t.useState,a=t.useEffect,o=t.useLayoutEffect,s=t.useDebugValue;function c(e,t){var n=t(),r=i({inst:{value:n,getSnapshot:t}}),c=r[0].inst,u=r[1];return o(function(){c.value=n,c.getSnapshot=t,l(c)&&u({inst:c})},[e,n,t]),a(function(){return l(c)&&u({inst:c}),e(function(){l(c)&&u({inst:c})})},[e]),s(n),n}function l(e){var t=e.getSnapshot;e=e.value;try{var n=t();return!r(e,n)}catch{return!0}}function u(e,t){return t()}var f=typeof window>`u`||window.document===void 0||window.document.createElement===void 0?u:c;e.useSyncExternalStore=t.useSyncExternalStore===void 0?f:t.useSyncExternalStore})),mb=s(((e,t)=>{t.exports=pb()})),hb=s((e=>{var t=(Q(),d(Zm)),n=mb();function r(e,t){return e===t&&(e!==0||1/e==1/t)||e!==e&&t!==t}var i=typeof Object.is==`function`?Object.is:r,a=n.useSyncExternalStore,o=t.useRef,s=t.useEffect,c=t.useMemo,l=t.useDebugValue;e.useSyncExternalStoreWithSelector=function(e,t,n,r,u){var d=o(null);if(d.current===null){var f={hasValue:!1,value:null};d.current=f}else f=d.current;d=c(function(){function e(e){if(!a){if(a=!0,o=e,e=r(e),u!==void 0&&f.hasValue){var t=f.value;if(u(t,e))return s=t}return s=e}if(t=s,i(o,e))return t;var n=r(e);return u!==void 0&&u(t,n)?(o=e,t):(o=e,s=n)}var a=!1,o,s,c=n===void 0?null:n;return[function(){return e(t())},c===null?void 0:function(){return e(c())}]},[t,n,r,u]);var p=a(e,d[0],d[1]);return s(function(){f.hasValue=!0,f.value=p},[p]),l(p),p}})),gb=s(((e,t)=>{t.exports=hb()}));Q();var _b=[],vb=void 0;function yb(){return vb}function bb(e){_b.push(e)}Q();var xb=mb(),Sb=gb(),Cb=dg(19)?Eb:Db;function wb(e,t,n,r,i){return Cb(e,t,n,r,i)}function Tb(e,t,n,r,i){let a=Te(()=>t(e.getSnapshot(),n,r,i),[e,t,n,r,i]);return(0,xb.useSyncExternalStore)(e.subscribe,a,a)}bb({before(e){e.syncIndex=0,e.didInitialize||(e.syncTick=1,e.syncHooks=[],e.didChangeStore=!0,e.getSnapshot=()=>{let t=!1;for(let n=0;n<e.syncHooks.length;n+=1){let r=e.syncHooks[n],i=r.selector(r.store.state,r.a1,r.a2,r.a3);(r.didChange||!Object.is(r.value,i))&&(t=!0,r.value=i,r.didChange=!1)}return t&&(e.syncTick+=1),e.syncTick})},after(e){e.syncHooks.length>0&&(e.didChangeStore&&(e.didChangeStore=!1,e.subscribe=t=>{let n=new Set;for(let t of e.syncHooks)n.add(t.store);let r=[];for(let e of n)r.push(e.subscribe(t));return()=>{for(let e of r)e()}}),(0,xb.useSyncExternalStore)(e.subscribe,e.getSnapshot,e.getSnapshot))}});function Eb(e,t,n,r,i){let a=yb();if(!a)return Tb(e,t,n,r,i);let o=a.syncIndex;a.syncIndex+=1;let s;return a.didInitialize?(s=a.syncHooks[o],(s.store!==e||s.selector!==t||!Object.is(s.a1,n)||!Object.is(s.a2,r)||!Object.is(s.a3,i))&&(s.store!==e&&(a.didChangeStore=!0),s.store=e,s.selector=t,s.a1=n,s.a2=r,s.a3=i,s.didChange=!0)):(s={store:e,selector:t,a1:n,a2:r,a3:i,value:t(e.getSnapshot(),n,r,i),didChange:!1},a.syncHooks.push(s)),s.value}function Db(e,t,n,r,i){return(0,Sb.useSyncExternalStoreWithSelector)(e.subscribe,e.getSnapshot,e.getSnapshot,e=>t(e,n,r,i))}var Ob=class{constructor(e){this.state=e,this.listeners=new Set,this.updateTick=0}subscribe=e=>(this.listeners.add(e),()=>{this.listeners.delete(e)});getSnapshot=()=>this.state;setState(e){if(this.state===e)return;this.state=e,this.updateTick+=1;let t=this.updateTick;for(let n of this.listeners){if(t!==this.updateTick)return;n(e)}}update(e){for(let t in e)if(!Object.is(this.state[t],e[t])){this.setState({...this.state,...e});return}}set(e,t){Object.is(this.state[e],t)||this.setState({...this.state,[e]:t})}notifyAll(){let e={...this.state};this.setState(e)}use(e,t,n,r){return wb(this,e,t,n,r)}};Q();var kb=class extends Ob{constructor(e,t={},n){super(e),this.context=t,this.selectors=n}useSyncedValue(e,t){De(e),__(()=>{this.state[e]!==t&&this.set(e,t)},[e,t])}useSyncedValueWithCleanup(e,t){let n=this;__(()=>(n.state[e]!==t&&n.set(e,t),()=>{n.set(e,void 0)}),[n,e,t])}useSyncedValues(e){let t=this;__(()=>{t.update(e)},[t,...Object.values(e)])}useControlledProp(e,t){De(e);let n=t!==void 0;__(()=>{n&&!Object.is(this.state[e],t)&&super.setState({...this.state,[e]:t})},[e,t,n])}select(e,t,n,r){let i=this.selectors[e];return i(this.state,t,n,r)}useState(e,t,n,r){return De(e),wb(this,this.selectors[e],t,n,r)}useContextCallback(e,t){De(e);let n=p_(t??kg);this.context[e]=n}useStateSetter(e){let t=W(void 0);return t.current===void 0&&(t.current=t=>{this.set(e,t)}),t.current}observe(e,t){let n;n=typeof e==`function`?e:this.selectors[e];let r=n(this.state);return t(r,r,this),this.subscribe(e=>{let i=n(e);if(!Object.is(r,i)){let e=r;r=i,t(i,e,this)}})}},Ab={open:fb(e=>e.open),domReferenceElement:fb(e=>e.domReferenceElement),referenceElement:fb(e=>e.positionReference??e.referenceElement),floatingElement:fb(e=>e.floatingElement),floatingId:fb(e=>e.floatingId)},jb=class extends kb{constructor(e){let{nested:t,noEmit:n,onOpenChange:r,triggerElements:i,...a}=e;super({...a,positionReference:a.referenceElement,domReferenceElement:a.referenceElement},{onOpenChange:r,dataRef:{current:{}},events:Ty(),nested:t,noEmit:n,triggerElements:i},Ab)}setOpen=(e,t)=>{if((!e||!this.state.open||lv(t.event))&&(this.context.dataRef.current.openEvent=e?t.event:void 0),!this.context.noEmit){let n={open:e,reason:t.reason,nativeEvent:t.event,nested:this.context.nested,triggerElement:t.trigger};this.context.events.emit(`openchange`,n)}this.context.onOpenChange?.(e,t)}};Q();function Mb(e,t=!1,n=!1){let[r,i]=H(e&&t?`idle`:void 0),[a,o]=H(e);return e&&!a&&(o(!0),i(`starting`)),!e&&a&&r!==`ending`&&!n&&i(`ending`),!e&&!a&&r===`ending`&&i(void 0),__(()=>{if(!e&&a&&r!==`ending`&&n){let e=ey.request(()=>{i(`ending`)});return()=>{ey.cancel(e)}}},[e,a,r,n]),__(()=>{if(!e||t)return;let n=ey.request(()=>{i(void 0)});return()=>{ey.cancel(n)}},[t,e]),__(()=>{if(!e||!t)return;e&&a&&r!==`idle`&&i(`starting`);let n=ey.request(()=>{i(`idle`)});return()=>{ey.cancel(n)}},[t,e,a,i,r]),G(()=>({mounted:a,setMounted:o,transitionStatus:r}),[a,r])}Q();function Nb(e,t=!1,n=!0){let r=ty();return p_((i,a=null)=>{r.cancel();function o(){Yh(i)}let s=Ay(e);if(s==null)return;let c=s;if(typeof c.getAnimations!=`function`||globalThis.BASE_UI_ANIMATIONS_DISABLED)i();else{function e(){let e=Lg.startingStyle;if(!c.hasAttribute(e)){r.request(i);return}let t=new MutationObserver(()=>{c.hasAttribute(e)||(t.disconnect(),i())});t.observe(c,{attributes:!0,attributeFilter:[e]}),a?.addEventListener(`abort`,()=>t.disconnect(),{once:!0})}function i(){Promise.all(c.getAnimations().map(e=>e.finished)).then(()=>{a?.aborted||o()}).catch(()=>{let e=c.getAnimations();if(n){if(a?.aborted)return;o()}else e.length>0&&e.some(e=>e.pending||e.playState!==`finished`)&&i()})}if(t){e();return}r.request(i)}})}Q();function Pb(e){let{enabled:t=!0,open:n,ref:r,onComplete:i}=e,a=p_(i),o=Nb(r,n,!1);U(()=>{if(!t)return;let e=new AbortController;return o(a,e.signal),()=>{e.abort()}},[t,n,a,o])}Q();function Fb(e){let t=e.useState(`open`);__(()=>{if(t&&!e.select(`activeTriggerId`)&&e.context.triggerElements.size===1){let t=e.context.triggerElements.entries().next();if(!t.done){let[n,r]=t.value;e.update({activeTriggerId:n,activeTriggerElement:r})}}},[t,e])}function Ib(e,t,n){let{mounted:r,setMounted:i,transitionStatus:a}=Mb(e);t.useSyncedValues({mounted:r,transitionStatus:a});let o=p_(()=>{i(!1),t.update({activeTriggerId:null,activeTriggerElement:null,mounted:!1}),n?.(),t.context.onOpenChangeComplete?.(!1)});return Pb({enabled:!t.useState(`preventUnmountingOnClose`),open:e,ref:t.context.popupRef,onComplete(){e||o()}}),{forceUnmount:o,transitionStatus:a}}var Lb=class{constructor(){this.elementsSet=new Set,this.idMap=new Map}add(e,t){let n=this.idMap.get(e);n!==t&&(n!==void 0&&this.elementsSet.delete(n),this.elementsSet.add(t),this.idMap.set(e,t))}delete(e){let t=this.idMap.get(e);t&&(this.elementsSet.delete(t),this.idMap.delete(e))}hasElement(e){return this.elementsSet.has(e)}hasMatchingElement(e){for(let t of this.elementsSet)if(e(t))return!0;return!1}getById(e){return this.idMap.get(e)}entries(){return this.idMap.entries()}elements(){return this.elementsSet.values()}get size(){return this.idMap.size}};function Rb(){return new jb({open:!1,floatingElement:null,referenceElement:null,triggerElements:new Lb,floatingId:``,nested:!1,noEmit:!1,onOpenChange:void 0})}function zb(){return{open:!1,openProp:void 0,mounted:!1,transitionStatus:`idle`,floatingRootContext:Rb(),preventUnmountingOnClose:!1,payload:void 0,activeTriggerId:null,activeTriggerElement:null,triggerIdProp:void 0,popupElement:null,positionerElement:null,activeTriggerProps:Ag,inactiveTriggerProps:Ag,popupProps:Ag}}var Bb=fb(e=>e.triggerIdProp??e.activeTriggerId),Vb={open:fb(e=>e.openProp??e.open),mounted:fb(e=>e.mounted),transitionStatus:fb(e=>e.transitionStatus),floatingRootContext:fb(e=>e.floatingRootContext),preventUnmountingOnClose:fb(e=>e.preventUnmountingOnClose),payload:fb(e=>e.payload),activeTriggerId:Bb,activeTriggerElement:fb(e=>e.mounted?e.activeTriggerElement:null),isTriggerActive:fb((e,t)=>t!==void 0&&Bb(e)===t),isOpenedByTrigger:fb((e,t)=>t!==void 0&&Bb(e)===t&&e.open),isMountedByTrigger:fb((e,t)=>t!==void 0&&Bb(e)===t&&e.mounted),triggerProps:fb((e,t)=>t?e.activeTriggerProps:e.inactiveTriggerProps),popupProps:fb(e=>e.popupProps),popupElement:fb(e=>e.popupElement),positionerElement:fb(e=>e.positionerElement)};function Hb(e){let{popupStore:t,noEmit:n=!1,treatPopupAsFloatingElement:r=!1,onOpenChange:i}=e,a=O_(),o=Oy()!=null,s=t.useState(`open`),c=t.useState(`activeTriggerElement`),l=t.useState(r?`popupElement`:`positionerElement`),u=t.context.triggerElements,d=rg(()=>new jb({open:s,referenceElement:c,floatingElement:l,triggerElements:u,onOpenChange:i,floatingId:a,nested:o,noEmit:n})).current;return __(()=>{let e={open:s,floatingId:a,referenceElement:c,floatingElement:l};n_(c)&&(e.domReferenceElement=c),d.state.positionReference===d.state.referenceElement&&(e.positionReference=c),d.update(e)},[s,a,c,l,d]),d.context.onOpenChange=i,d.context.nested=o,d.context.noEmit=n,d}Q();function Ub(e=[]){let t=e.map(e=>e?.reference),n=e.map(e=>e?.floating),r=e.map(e=>e?.item),i=e.map(e=>e?.trigger),a=Te(t=>Wb(t,e,`reference`),t),o=Te(t=>Wb(t,e,`floating`),n),s=Te(t=>Wb(t,e,`item`),r),c=Te(t=>Wb(t,e,`trigger`),i);return G(()=>({getReferenceProps:a,getFloatingProps:o,getItemProps:s,getTriggerProps:c}),[a,o,s,c])}function Wb(e,t,n){let r=new Map,i=n===`item`,a={};n===`floating`&&(a.tabIndex=-1,a[J_]=``);for(let t in e)i&&e&&(t===`active`||t===`selected`)||(a[t]=e[t]);for(let o=0;o<t.length;o+=1){let s,c=t[o]?.[n];s=typeof c==`function`?e?c(e):null:c,s&&Gb(a,s,i,r)}return Gb(a,e,i,r),a}function Gb(e,t,n,r){for(let i in t){let a=t[i];n&&(i===`active`||i===`selected`)||(i.startsWith(`on`)?(r.has(i)||r.set(i,[]),typeof a==`function`&&(r.get(i)?.push(a),e[i]=(...e)=>r.get(i)?.map(t=>t(...e)).find(e=>e!==void 0))):e[i]=a)}}Q();var Kb=new Map([[`select`,`listbox`],[`combobox`,`listbox`],[`label`,!1]]);function qb(e,t={}){let n=`rootStore`in e?e.rootStore:e,r=n.useState(`open`),i=n.useState(`floatingId`),a=n.useState(`domReferenceElement`),o=n.useState(`floatingElement`),{role:s=`dialog`}=t,c=O_(),l=a?.id||c,u=G(()=>nv(o)?.id||i,[o,i]),d=Kb.get(s)??s,f=Oy()!=null,p=G(()=>d===`tooltip`||s===`label`?Ag:{"aria-haspopup":d===`alertdialog`?`dialog`:d,"aria-expanded":`false`,...d===`listbox`&&{role:`combobox`},...d===`menu`&&f&&{role:`menuitem`},...s===`select`&&{"aria-autocomplete":`none`},...s===`combobox`&&{"aria-autocomplete":`list`}},[d,f,s]),m=G(()=>d===`tooltip`||s===`label`?{[`aria-${s===`label`?`labelledby`:`describedby`}`]:r?u:void 0}:{...p,"aria-expanded":r?`true`:`false`,"aria-controls":r?u:void 0,...d===`menu`&&{id:l}},[d,u,r,l,s,p]),h=G(()=>{let e={id:u,...d&&{role:d}};return d===`tooltip`||s===`label`?e:{...e,...d===`menu`&&{"aria-labelledby":l}}},[d,u,l,s]),g=Te(({active:e,selected:t})=>{let n={role:`option`,...e&&{id:`${u}-fui-option`}};switch(s){case`select`:case`combobox`:return{...n,"aria-selected":t};default:}return{}},[u,s]);return G(()=>({reference:m,floating:h,item:g,trigger:p}),[m,h,p,g])}var Jb=function(e){return e[e.open=Vg.open]=`open`,e[e.closed=Vg.closed]=`closed`,e[e.startingStyle=Vg.startingStyle]=`startingStyle`,e[e.endingStyle=Vg.endingStyle]=`endingStyle`,e.expanded=`data-expanded`,e.nestedDrawerOpen=`data-nested-drawer-open`,e.nestedDrawerSwiping=`data-nested-drawer-swiping`,e.swipeDismiss=`data-swipe-dismiss`,e.swipeDirection=`data-swipe-direction`,e.swiping=`data-swiping`,e}({});Q();var Yb=z(void 0);function Xb(){let e=Ee(Yb);if(e===void 0)throw Error($h(26));return e}var Zb=`ArrowUp`,Qb=`ArrowDown`,$b=`ArrowLeft`,ex=`ArrowRight`,tx=`Home`,nx=new Set([$b,ex]),rx=new Set([Zb,Qb]),ix=new Set([...nx,...rx]);new Set([...ix,tx,`End`]);var ax=new Set([Zb,Qb,$b,ex,tx,`End`]);Q();var ox=z(void 0);function sx(e){let t=Ee(ox);if(e===!1&&t===void 0)throw Error($h(90));return t}function cx(e,t=-(2**53-1),n=2**53-1){return Math.max(t,Math.min(e,n))}Q();function lx(e,t,n){if(!Number.isFinite(t)||t<=0)return null;if(typeof e==`number`)return Number.isFinite(e)?e<=1?cx(e,0,1)*t:e:null;let r=e.trim();if(r.endsWith(`px`)){let e=Number.parseFloat(r);return Number.isFinite(e)?e:null}if(r.endsWith(`rem`)){let e=Number.parseFloat(r);return Number.isFinite(e)?e*n:null}return null}function ux(e,t){let n=null,r=1/0;for(let i of t){let t=Math.abs(i.height-e);t<r&&(r=t,n=i)}return n}function dx(){let{store:e}=tg(),{snapPoints:t,activeSnapPoint:n,setActiveSnapPoint:r,popupHeight:i}=sx(),a=e.useState(`viewportElement`),[o,s]=H(0),[c,l]=H(16),u=p_(()=>{let e=Vv(a).documentElement;a&&s(a.offsetHeight),a||s(e.clientHeight);let t=parseFloat(getComputedStyle(e).fontSize);Number.isFinite(t)&&l(t)});__(()=>{if(u(),!a||typeof ResizeObserver!=`function`)return;let e=new ResizeObserver(u);return e.observe(a),()=>{e.disconnect()}},[u,a]);let d=G(()=>{if(!t||t.length===0||o<=0||i<=0)return[];let e=Math.min(i,o);if(!Number.isFinite(e)||e<=0)return[];let n=t.map(t=>{let n=lx(t,o,c);if(n===null||!Number.isFinite(n))return null;let r=cx(n,0,e);return{value:t,height:r,offset:Math.max(0,i-r)}}).filter(e=>!!e);if(n.length<=1)return n;let r=[],a=[];for(let e=n.length-1;e>=0;--e){let t=n[e];a.some(e=>Math.abs(e-t.height)<=1)||(a.push(t.height),r.push(t))}return r.reverse(),r},[i,c,t,o]);return{snapPoints:t,activeSnapPoint:n,setActiveSnapPoint:r,popupHeight:i,viewportHeight:o,resolvedSnapPoints:d,activeSnapPointOffset:G(()=>{if(n===void 0)return d[0];if(n===null)return;let e=d.find(e=>Object.is(e.value,n));if(e)return e;let t=Math.min(i,o),r=lx(n,o,c);if(!(r===null||!Number.isFinite(r)))return ux(cx(r,0,t),d)??void 0},[n,i,d,c,o])?.offset??null}}Q();var fx=z(null);function px(e){let t=Ee(fx);if(e===!1&&t===null)throw Error($h(92));return t}Q();var mx=!1;function hx(){mx||=(typeof CSS<`u`&&`registerProperty`in CSS&&([qg.swipeMovementX,qg.swipeMovementY,qg.snapPointOffset].forEach(e=>{try{CSS.registerProperty({name:e,syntax:`<length>`,inherits:!1,initialValue:`0px`})}catch{}}),[{name:Jg.swipeProgress,initialValue:`0`},{name:qg.swipeStrength,initialValue:`1`}].forEach(({name:e,initialValue:t})=>{try{CSS.registerProperty({name:e,syntax:`<number>`,inherits:!1,initialValue:t})}catch{}})),!0)}var gx={...Kg,...Bg,expanded(e){return e?{[Jb.expanded]:``}:null},nestedDrawerOpen(e){return e?{[Jb.nestedDrawerOpen]:``}:null},nestedDrawerSwiping(e){return e?{[Jb.nestedDrawerSwiping]:``}:null},swipeDirection(e){return e?{[Jb.swipeDirection]:e}:null},swiping(e){return e?{[Jb.swiping]:``}:null}},_x=sh(function(e,t){let{className:n,finalFocus:r,initialFocus:i,render:a,...o}=e,{store:s}=tg(),{swipeDirection:c,frontmostHeight:l,hasNestedDrawer:u,nestedSwiping:d,nestedSwipeProgressStore:f,onPopupHeightChange:p,notifyParentFrontmostHeight:m,notifyParentHasNestedDrawer:h}=sx(),g=s.useState(`descriptionElementId`),_=s.useState(`disablePointerDismissal`),v=s.useState(`floatingRootContext`),y=s.useState(`popupProps`),b=s.useState(`modal`),x=s.useState(`mounted`),S=s.useState(`nested`),C=s.useState(`nestedOpenDialogCount`),w=s.useState(`transitionStatus`),T=s.useState(`open`),E=s.useState(`openMethod`),D=s.useState(`titleElementId`),O=s.useState(`role`),k=C>0,A=px(!0),j=A?.swiping??!1,M=A?.swipeStrength??null,{snapPoints:ee,activeSnapPoint:N,activeSnapPointOffset:P}=dx();Xb();let[te,ne]=H(0),F=W(0),I=p_(()=>{let e=s.context.popupRef.current;if(!e)return;let t=e.offsetHeight;if(F.current>0&&l>F.current&&t>F.current)return;if(F.current>0&&u){let e=F.current;ne(e),p(e);return}let n=t;n!==F.current&&(F.current=n,ne(n),p(n))});__(()=>{if(!x){F.current=0,ne(0),p(0);return}let e=s.context.popupRef.current;if(!e||(hx(),I(),typeof ResizeObserver!=`function`))return;let t=new ResizeObserver(I);return t.observe(e),()=>{t.disconnect()}},[I,x,k,p,s.context.popupRef]),__(()=>{let e=s.context.popupRef,t=()=>{let t=e.current;if(!t)return;let n=f.getSnapshot();n>0?t.style.setProperty(Jg.swipeProgress,`${n}`):t.style.setProperty(Jg.swipeProgress,`0`)};t();let n=f.subscribe(t);return()=>{n();let t=e.current;t&&t.style.setProperty(Jg.swipeProgress,`0`)}},[f,s.context.popupRef]),U(()=>{if(T)return m?.(l),()=>{m?.(0)}},[l,T,m]),U(()=>{if(h)return h(T||w===`ending`),()=>{h(!1)}},[h,T,w]),Pb({open:T,ref:s.context.popupRef,onComplete(){T&&s.context.onOpenChangeComplete?.(!0)}});let L=i===void 0?s.context.popupRef:i,R={open:T,nested:S,transitionStatus:w,expanded:N===1,nestedDrawerOpen:k,nestedDrawerSwiping:d,swipeDirection:c,swiping:j},re;te&&!(!u&&w!==`ending`)&&(re=`${te}px`);let ie=ee&&ee.length>0&&(c===`down`||c===`up`),z=null;ie&&P!==null&&(z=c===`up`?-P:P);let B=A?A.getDragStyles():Ag;if(ie&&c===`down`){let e=P??0,t=Number.parseFloat(String(B[qg.swipeMovementY]??0)),n=Number.isFinite(t)?e+t:e;if(j&&n<0&&Number.isFinite(t)){let t=Math.abs(n),r=-Math.sqrt(t)-e;B={...B,transform:void 0,[qg.swipeMovementY]:`${r}px`}}else B={...B,transform:void 0}}let V=Mg(`div`,e,{state:R,props:[y,{"aria-labelledby":D,"aria-describedby":g,role:O,tabIndex:-1,hidden:!x,onKeyDown(e){ax.has(e.key)&&e.stopPropagation()},style:{...B,[Jg.swipeProgress]:`0`,[qg.nestedDrawers]:C,[qg.height]:re,[qg.snapPointOffset]:typeof z==`number`?`${z}px`:`0px`,[qg.frontmostHeight]:l?`${l}px`:void 0,[qg.swipeStrength]:typeof M==`number`&&Number.isFinite(M)&&M>0?`${M}`:`1`}},o],ref:[t,s.context.popupRef,s.useStateSetter(`popupElement`)],stateAttributesMapping:gx});return $(By,{context:v,openInteractionType:E,disabled:!x,closeOnFocusOut:!_,initialFocus:L,returnFocus:r,modal:b!==!1,restoreFocus:`popup`,children:V})});function vx(e){return dg(19)?e:e?`true`:void 0}Q();var yx=sh(function(e,t){let{cutout:n,...r}=e,i;if(n){let e=n?.getBoundingClientRect();i=`polygon(
      0% 0%,
      100% 0%,
      100% 100%,
      0% 100%,
      ...
      ${e.right}px ${e.top}px,
      ${e.left}px ${e.top}px
    )`}return $(`div`,{ref:t,role:`presentation`,"data-base-ui-inert":``,...r,style:{position:`fixed`,inset:0,userSelect:`none`,WebkitUserSelect:`none`,clipPath:i}})});Q();var bx=sh(function(e,t){let{keepMounted:n=!1,...r}=e,{store:i}=tg(),a=i.useState(`mounted`),o=i.useState(`modal`),s=i.useState(`open`);return a||n?$(Yb.Provider,{value:n,children:$(wy,{ref:t,...r,children:[a&&o===!0&&$(yx,{ref:i.context.internalBackdropRef,inert:vx(!s)}),e.children]})}):null});Q();function xx({controlled:e,default:t,name:n,state:r=`value`}){let{current:i}=W(e!==void 0),[a,o]=H(t);return[i?e:a,Te(e=>{i||o(e)},[])]}Q();function Sx(e){let t=W(!0);t.current&&(t.current=!1,e())}var Cx={},wx={},Tx=``;function Ex(e){if(typeof document>`u`)return!1;let t=Vv(e);return $g(t).innerWidth-t.documentElement.clientWidth>0}function Dx(e){if(!(typeof CSS<`u`&&CSS.supports&&CSS.supports(`scrollbar-gutter`,`stable`))||typeof document>`u`)return!1;let t=Vv(e),n=t.documentElement,r=t.body,i=a_(n)?n:r,a=i.style.overflowY,o=n.style.scrollbarGutter;n.style.scrollbarGutter=`stable`,i.style.overflowY=`scroll`;let s=i.offsetWidth;i.style.overflowY=`hidden`;let c=i.offsetWidth;return i.style.overflowY=a,n.style.scrollbarGutter=o,s===c}function Ox(e){let t=Vv(e),n=t.documentElement,r=t.body,i=a_(n)?n:r,a={overflowY:i.style.overflowY,overflowX:i.style.overflowX};return Object.assign(i.style,{overflowY:`hidden`,overflowX:`hidden`}),()=>{Object.assign(i.style,a)}}function kx(e){let t=Vv(e),n=t.documentElement,r=t.body,i=$g(n),a=0,o=0,s=!1,c=ey.create();if(B_&&(i.visualViewport?.scale??1)!==1)return()=>{};function l(){let t=i.getComputedStyle(n),c=i.getComputedStyle(r),l=(t.scrollbarGutter||``).includes(`both-edges`)?`stable both-edges`:`stable`;a=n.scrollTop,o=n.scrollLeft,Cx={scrollbarGutter:n.style.scrollbarGutter,overflowY:n.style.overflowY,overflowX:n.style.overflowX},Tx=n.style.scrollBehavior,wx={position:r.style.position,height:r.style.height,width:r.style.width,boxSizing:r.style.boxSizing,overflowY:r.style.overflowY,overflowX:r.style.overflowX,scrollBehavior:r.style.scrollBehavior};let u=n.scrollHeight>n.clientHeight,d=n.scrollWidth>n.clientWidth,f=t.overflowY===`scroll`||c.overflowY===`scroll`,p=t.overflowX===`scroll`||c.overflowX===`scroll`,m=Math.max(0,i.innerWidth-r.clientWidth),h=Math.max(0,i.innerHeight-r.clientHeight),g=parseFloat(c.marginTop)+parseFloat(c.marginBottom),_=parseFloat(c.marginLeft)+parseFloat(c.marginRight),v=a_(n)?n:r;if(s=Dx(e),s){n.style.scrollbarGutter=l,v.style.overflowY=`hidden`,v.style.overflowX=`hidden`;return}Object.assign(n.style,{scrollbarGutter:l,overflowY:`hidden`,overflowX:`hidden`}),(u||f)&&(n.style.overflowY=`scroll`),(d||p)&&(n.style.overflowX=`scroll`),Object.assign(r.style,{position:`relative`,height:g||h?`calc(100dvh - ${g+h}px)`:`100dvh`,width:_||m?`calc(100vw - ${_+m}px)`:`100vw`,boxSizing:`border-box`,overflow:`hidden`,scrollBehavior:`unset`}),r.scrollTop=a,r.scrollLeft=o,n.setAttribute(`data-base-ui-scroll-locked`,``),n.style.scrollBehavior=`unset`}function u(){Object.assign(n.style,Cx),Object.assign(r.style,wx),s||(n.scrollTop=a,n.scrollLeft=o,n.removeAttribute(`data-base-ui-scroll-locked`),n.style.scrollBehavior=Tx)}function d(){u(),c.request(l)}return l(),i.addEventListener(`resize`,d),()=>{c.cancel(),u(),typeof i.removeEventListener==`function`&&i.removeEventListener(`resize`,d)}}var Ax=new class{lockCount=0;restore=null;timeoutLock=P_.create();timeoutUnlock=P_.create();acquire(e){return this.lockCount+=1,this.lockCount===1&&this.restore===null&&this.timeoutLock.start(0,()=>this.lock(e)),this.release}release=()=>{--this.lockCount,this.lockCount===0&&this.restore&&this.timeoutUnlock.start(0,this.unlock)};unlock=()=>{this.lockCount===0&&this.restore&&(this.restore?.(),this.restore=null)};lock(e){if(this.lockCount===0||this.restore!==null)return;let t=Vv(e).documentElement,n=$g(t).getComputedStyle(t).overflowY;if(n===`hidden`||n===`clip`){this.restore=kg;return}this.restore=V_||!Ex(e)?Ox(e):kx(e)}};function jx(e=!0,t=null){__(()=>{if(e)return Ax.acquire(t)},[e,t])}Q();function Mx(e){let t=W(``),n=Te(n=>{n.defaultPrevented||(t.current=n.pointerType,e(n,n.pointerType))},[e]);return{onClick:Te(n=>{if(n.detail===0){e(n,`keyboard`);return}`pointerType`in n?e(n,n.pointerType):e(n,t.current),t.current=``},[e]),onPointerDown:n}}Q();function Nx(e,t){let n=W(e),r=p_(t);__(()=>{n.current!==e&&r(n.current)},[e,r]),__(()=>{n.current=e},[e])}Q();function Px(e){let[t,n]=H(null),r=p_((t,r)=>{e||n(r||(V_?`touch`:``))});Nx(e,t=>{t&&!e&&n(null)});let{onClick:i,onPointerDown:a}=Mx(r);return G(()=>({openMethod:t,triggerProps:{onClick:i,onPointerDown:a}}),[t,i,a])}Q();function Fx(e){let{store:t,parentContext:n,actionsRef:r}=e,i=t.useState(`open`),a=t.useState(`disablePointerDismissal`),o=t.useState(`modal`),s=t.useState(`popupElement`),{openMethod:c,triggerProps:l}=Px(i);Fb(t);let{forceUnmount:u}=Ib(i,t),d=p_(e=>{let n=w_(e);return n.preventUnmountOnClose=()=>{t.set(`preventUnmountingOnClose`,!0)},n}),f=Te(()=>{t.setOpen(!1,d(C_))},[t,d]);we(r,()=>({unmount:u,close:f}),[u,f]);let p=Hb({popupStore:t,onOpenChange:t.setOpen,treatPopupAsFloatingElement:!0,noEmit:!0}),[m,h]=H(0),g=m===0,_=qb(p),v=Wy(p,{outsidePressEvent(){return t.context.internalBackdropRef.current||t.context.backdropRef.current?`intentional`:{mouse:o===`trap-focus`?`sloppy`:`intentional`,touch:`sloppy`}},outsidePress(e){if(!t.context.outsidePressEnabledRef.current||`button`in e&&e.button!==0||`touches`in e&&e.touches.length!==1)return!1;let n=Z_(e);if(g&&!a){let e=n;return o&&(t.context.internalBackdropRef.current||t.context.backdropRef.current)?t.context.internalBackdropRef.current===e||t.context.backdropRef.current===e||X_(e,s)&&!e?.hasAttribute(`data-base-ui-portal`):!0}return!1},escapeKey:g});jx(i&&o===!0,s);let{getReferenceProps:y,getFloatingProps:b,getTriggerProps:x}=Ub([_,v]);t.useContextCallback(`onNestedDialogOpen`,e=>{h(e+1)}),t.useContextCallback(`onNestedDialogClose`,()=>{h(0)}),U(()=>(n?.onNestedDialogOpen&&i&&n.onNestedDialogOpen(m),n?.onNestedDialogClose&&!i&&n.onNestedDialogClose(),()=>{n?.onNestedDialogClose&&i&&n.onNestedDialogClose()}),[i,n,m]);let S=G(()=>y(l),[y,l]),C=G(()=>x(l),[x,l]),w=G(()=>b(),[b]);t.useSyncedValues({openMethod:c,activeTriggerProps:S,inactiveTriggerProps:C,popupProps:w,floatingRootContext:p,nestedOpenDialogCount:m})}Q();var Ix={...Vb,modal:fb(e=>e.modal),nested:fb(e=>e.nested),nestedOpenDialogCount:fb(e=>e.nestedOpenDialogCount),disablePointerDismissal:fb(e=>e.disablePointerDismissal),openMethod:fb(e=>e.openMethod),descriptionElementId:fb(e=>e.descriptionElementId),titleElementId:fb(e=>e.titleElementId),viewportElement:fb(e=>e.viewportElement),role:fb(e=>e.role)},Lx=class extends kb{constructor(e){super(Rx(e),{popupRef:_(),backdropRef:_(),internalBackdropRef:_(),outsidePressEnabledRef:{current:!0},triggerElements:new Lb,onOpenChange:void 0,onOpenChangeComplete:void 0},Ix)}setOpen=(e,t)=>{if(t.preventUnmountOnClose=()=>{this.set(`preventUnmountingOnClose`,!0)},!e&&t.trigger==null&&this.state.activeTriggerId!=null&&(t.trigger=this.state.activeTriggerElement??void 0),this.context.onOpenChange?.(e,t),t.isCanceled)return;let n={open:e,nativeEvent:t.event,reason:t.reason,nested:this.state.nested};this.state.floatingRootContext.context.events?.emit(`openchange`,n);let r={open:e},i=t.trigger?.id??null;(i||e)&&(r.activeTriggerId=i,r.activeTriggerElement=t.trigger??null),this.update(r)}};function Rx(e={}){return{...zb(),modal:!0,disablePointerDismissal:!1,popupElement:null,viewportElement:null,descriptionElementId:void 0,titleElementId:void 0,openMethod:null,nested:!1,nestedOpenDialogCount:0,role:`dialog`,...e}}Q();function zx(e){let{children:t,open:n,defaultOpen:r=!1,onOpenChange:i,onOpenChangeComplete:a,disablePointerDismissal:o=!1,modal:s=!0,actionsRef:c,handle:l,triggerId:u,defaultTriggerId:d=null}=e,f=tg(!0),p=!!f,m=rg(()=>l?.store??new Lx({open:r,openProp:n,activeTriggerId:d,triggerIdProp:u,modal:s,disablePointerDismissal:o,nested:p})).current;Sx(()=>{n===void 0&&m.state.open===!1&&r===!0&&m.update({open:!0,activeTriggerId:d})}),m.useControlledProp(`openProp`,n),m.useControlledProp(`triggerIdProp`,u),m.useSyncedValues({disablePointerDismissal:o,nested:p,modal:s}),m.useContextCallback(`onOpenChange`,i),m.useContextCallback(`onOpenChangeComplete`,a);let h=m.useState(`payload`);Fx({store:m,actionsRef:c,parentContext:f?.store.context,onOpenChange:i,triggerIdProp:u});let g=G(()=>({store:m}),[m]);return $(eg.Provider,{value:g,children:typeof t==`function`?t({payload:h}):t})}Q();var Bx,Vx;function Hx(e){let{children:t,open:n,defaultOpen:r=!1,onOpenChange:i,onOpenChangeComplete:a,disablePointerDismissal:o=!1,modal:s=!0,actionsRef:c,handle:l,triggerId:u,defaultTriggerId:d=null,swipeDirection:f=`down`,snapToSequentialPoints:p=!1,snapPoints:m,snapPoint:h,defaultSnapPoint:g,onSnapPointChange:_}=e,y=p_(_),b=sx(!0),x=b?.onNestedSwipeProgressChange,S=b?.onNestedFrontmostHeightChange,C=b?.onNestedSwipingChange,w=b?.onNestedDrawerPresenceChange,[T,E]=H(0),[D,O]=H(0),[k,A]=H(!1),[j,M]=H(!1),[ee]=H(Ux),N=g===void 0?m?.[0]??null:g,P=h!==void 0,[te,ne]=xx({controlled:h,default:N,name:`Drawer`,state:`snapPoint`}),F=W(!1),I=p_((e,t)=>{let n=t??w_(`none`);y?.(e,n),!n.isCanceled&&ne(e)}),L=G(()=>P||!m||m.length===0?te:te===null||!m.some(e=>Object.is(e,te))?N:te,[te,P,N,m]),R=p_(e=>{E(e),!F.current&&e>0&&O(e)}),re=p_(e=>{if(e>0){F.current=!0,O(e);return}F.current=!1,T>0&&O(T)}),ie=p_(e=>{A(e)}),z=p_(e=>{ee.set(e),x?.(e)}),B=p_(e=>{M(e),C?.(e)}),V=p_((e,t)=>{i?.(e,t),!t.isCanceled&&!e&&m&&m.length>0&&I(N,w_(t.reason,t.event,t.trigger))}),ae=G(()=>({swipeDirection:f,snapToSequentialPoints:p,snapPoints:m,activeSnapPoint:L,setActiveSnapPoint:I,frontmostHeight:D,popupHeight:T,hasNestedDrawer:k,nestedSwiping:j,nestedSwipeProgressStore:ee,onNestedDrawerPresenceChange:ie,onPopupHeightChange:R,onNestedFrontmostHeightChange:re,onNestedSwipingChange:B,onNestedSwipeProgressChange:z,notifyParentFrontmostHeight:S,notifyParentSwipingChange:C,notifyParentSwipeProgressChange:x,notifyParentHasNestedDrawer:w}),[L,D,k,j,ee,w,x,C,S,ie,re,z,B,R,T,I,m,p,f]),oe=typeof t==`function`?e=>$(v,{children:[Bx||=$(Wx,{}),t(e)]}):$(v,{children:[Vx||=$(Wx,{}),t]});return $(ox.Provider,{value:ae,children:$(zx,{open:n,defaultOpen:r,onOpenChange:V,onOpenChangeComplete:a,disablePointerDismissal:o,modal:s,actionsRef:c,handle:l,triggerId:u,defaultTriggerId:d,children:oe})})}function Ux(){let e=0,t=new Set;return{getSnapshot:()=>e,set(n){let r=Number.isFinite(n)?n:0;r!==e&&(e=r,t.forEach(e=>{e()}))},subscribe(e){return t.add(e),()=>{t.delete(e)}}}}function Wx(){let e=O_(),t=A_(!0),n=tg(!1),r=n.store.useState(`open`),i=n.store.useState(`nestedOpenDialogCount`),a=n.store.useState(`popupElement`),o=i===0;return U(()=>{if(!(!t||e==null))return()=>{t.removeDrawer(e)}},[e,t]),U(()=>{e!=null&&t?.setDrawerOpen(e,r)},[e,r,t]),U(()=>{if(!r||!o||!U_)return;let e=$g(a).CloseWatcher;if(!e)return;function t(e){n.store.select(`open`)&&n.store.setOpen(!1,w_(S_,e))}let i=new e;return i.addEventListener(`close`,t),()=>{i.removeEventListener(`close`,t),i.destroy()}},[n.store,o,r,a]),null}var Gx=null;function Kx(){Gx||(Gx=document.createElement(`style`),Gx.textContent=`
  ...
  `,document.head.appendChild(Gx))}function qx(){Gx&&=(Gx.remove(),null)}Xe();function Jx(e){Rt(()=>{if(!e.value)return;let t=()=>{e.value=!1},n=e=>{e.key===`Escape`&&t()};return window.addEventListener(`mousedown`,t),window.addEventListener(`keydown`,n),()=>{window.removeEventListener(`mousedown`,t),window.removeEventListener(`keydown`,n)}})}function Yx(e,t){if(!e)return null;let n=e.querySelector(`[data-slot="${t}"]`);if(!n)return null;let r=e.getBoundingClientRect(),i=n.getBoundingClientRect();return{left:i.left-r.left,width:i.width}}function Xx(e){Zt.value=e,e===`preview`?(Xt.value=`preview`,Gt.value=`review`):(Xt.value=`file`,e===`changes`?Gt.value=`changes`:Gt.value=`review`)}function Zx({onNewFile:e,onImportDocx:t,onExportDocx:n,onExportMd:r}){let i=jt(!1),a=jt(!1);Jx(i),Jx(a);let o=W(null),s=W(null),c=jt(null),l=jt(null),u=Zt.value,d=u===`preview`,f=Te(()=>{let e=Yx(o.current,Zt.value);e&&(c.value=e);let t=Yx(s.current,Zt.value);t&&(l.value=t)},[]);return U(()=>(f(),window.addEventListener(`resize`,f),()=>window.removeEventListener(`resize`,f)),[f]),U(()=>{requestAnimationFrame(f)},[u,f]),$(v,{children:[$(`header`,{class:`header`,children:[$(`div`,{class:`header-left`,children:[$(`button`,{class:`sidebar-toggle`,onClick:()=>{Qt.value=!Qt.value},title:Qt.value?`Hide sidebar`:`Show sidebar`,"aria-label":`Toggle sidebar`,children:$(`svg`,{width:`18`,height:`18`,viewBox:`0 0 18 18`,fill:`none`,children:[$(`rect`,{x:`2`,y:`4`,width:`14`,height:`1.5`,rx:`0.75`,fill:`currentColor`}),$(`rect`,{x:`2`,y:`8.25`,width:`14`,height:`1.5`,rx:`0.75`,fill:`currentColor`}),$(`rect`,{x:`2`,y:`12.5`,width:`14`,height:`1.5`,rx:`0.75`,fill:`currentColor`})]})}),$(`span`,{class:`header-brand`,onClick:()=>{Wt.value=Ut},style:{cursor:`pointer`},children:[$(`span`,{class:`header-brand-mark`,children:`◆`}),`changedown`]}),$(`a`,{class:`social-link`,href:`https://github.com/hackerbara`,target:`_blank`,rel:`noopener`,title:`GitHub`,children:$(`svg`,{width:`16`,height:`16`,viewBox:`0 0 16 16`,fill:`currentColor`,children:$(`path`,{d:`M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z`})})}),$(`a`,{class:`social-link`,href:`https://x.com/hackerbara`,target:`_blank`,rel:`noopener`,title:`X / Twitter`,children:$(`svg`,{width:`16`,height:`16`,viewBox:`0 0 16 16`,fill:`currentColor`,children:$(`path`,{d:`M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z`})})})]}),$(`div`,{class:`header-center`,children:$(`div`,{class:`view-slider`,ref:o,children:[c.value&&$(`div`,{class:`view-slider-pill`,style:{left:`${c.value.left}px`,width:`${c.value.width}px`}}),$(`button`,{"data-slot":`preview`,class:`vs-btn vs-preview ${u===`preview`?`active`:``}`,onClick:()=>Xx(`preview`),"aria-pressed":u===`preview`,children:`Preview`}),$(`div`,{class:`vs-divider`}),$(`div`,{class:`vs-file-section ${d?`dimmed`:``}`,children:$(`div`,{class:`vs-file-options`,children:[`markup`,`changes`].map(e=>$(`button`,{"data-slot":e,class:`vs-btn vs-sub ${u===e?`active`:``}`,onClick:()=>Xx(e),"aria-pressed":u===e,children:e===`changes`?`Simple`:`Markup`},e))})})]})}),$(`div`,{class:`header-right`})]}),$(`div`,{class:`mobile-view-bar`,children:[$(`div`,{class:`view-slider`,ref:s,children:[l.value&&$(`div`,{class:`view-slider-pill`,style:{left:`${l.value.left}px`,width:`${l.value.width}px`}}),$(`button`,{"data-slot":`preview`,class:`vs-btn vs-preview ${u===`preview`?`active`:``}`,onClick:()=>Xx(`preview`),"aria-pressed":u===`preview`,children:`Preview`}),$(`div`,{class:`vs-divider`}),$(`div`,{class:`vs-file-section ${d?`dimmed`:``}`,children:$(`div`,{class:`vs-file-options`,children:[`markup`,`changes`].map(e=>$(`button`,{"data-slot":e,class:`vs-btn vs-sub ${u===e?`active`:``}`,onClick:()=>Xx(e),"aria-pressed":u===e,children:e.charAt(0).toUpperCase()+e.slice(1)},e))})})]}),$(`button`,{class:`mobile-delimiters-btn ${Yt.value?`active`:``}`,onClick:()=>{Yt.value=!Yt.value,window.__changedownDecorationsActive||(Yt.value?qx():Kx())},title:Yt.value?`Hide delimiters`:`Show delimiters`,"aria-label":Yt.value?`Hide delimiters`:`Show delimiters`,children:$(`svg`,{width:`16`,height:`16`,viewBox:`0 0 14 14`,fill:`none`,children:$(`path`,{d:`M4.5 2C3.12 2 2 3.34 2 5s1.12 3 2.5 3M9.5 2C10.88 2 12 3.34 12 5s-1.12 3-2.5 3M4.5 8C3.12 8 2 9.34 2 11s1.12 3 2.5 3M9.5 8C10.88 8 12 9.34 12 11s-1.12 3-2.5 3`,stroke:`currentColor`,"stroke-width":`1.3`,"stroke-linecap":`round`})})}),$(`div`,{class:`action-dropdown-wrapper`,onMouseDown:e=>e.stopPropagation(),children:[$(`button`,{class:`action-menu-btn`,onClick:()=>{a.value=!a.value},children:`Import/Export`}),a.value&&$(`div`,{class:`action-menu`,children:[$(`button`,{onClick:()=>{a.value=!1,t()},children:`Import DOCX`}),$(`div`,{class:`action-menu-sep`}),$(`button`,{onClick:()=>{a.value=!1,n()},children:`Export DOCX`}),$(`button`,{onClick:()=>{a.value=!1,r()},children:`Export Markdown`}),$(`div`,{class:`action-menu-sep`}),$(`button`,{onClick:()=>{a.value=!1,e()},children:`New File`})]})]})]}),$(`div`,{class:`action-bar`,children:[$(`button`,{class:`action-btn sidebar-toggle-mobile`,onClick:()=>{Qt.value=!Qt.value},"aria-label":`Toggle sidebar`,children:[$(`svg`,{width:`16`,height:`16`,viewBox:`0 0 18 18`,fill:`none`,children:[$(`rect`,{x:`2`,y:`4`,width:`14`,height:`1.5`,rx:`0.75`,fill:`currentColor`}),$(`rect`,{x:`2`,y:`8.25`,width:`14`,height:`1.5`,rx:`0.75`,fill:`currentColor`}),$(`rect`,{x:`2`,y:`12.5`,width:`14`,height:`1.5`,rx:`0.75`,fill:`currentColor`})]}),`Files`]}),$(`button`,{class:`action-btn action-btn-accent`,onClick:t,children:[$(`svg`,{width:`14`,height:`14`,viewBox:`0 0 14 14`,fill:`none`,children:[$(`path`,{d:`M7 1v8M3 6l4 4 4-4`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`}),$(`path`,{d:`M1 11v2h12v-2`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`})]}),`Import DOCX`]}),$(`div`,{class:`export-dropdown`,onMouseDown:e=>e.stopPropagation(),children:[$(`button`,{class:`action-btn`,onClick:()=>{i.value=!i.value},title:`Export document`,children:[$(`svg`,{width:`14`,height:`14`,viewBox:`0 0 14 14`,fill:`none`,children:[$(`path`,{d:`M7 9V1M3 4l4-4 4 4`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`}),$(`path`,{d:`M1 11v2h12v-2`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`,"stroke-linejoin":`round`})]}),`Export`,$(`svg`,{width:`8`,height:`8`,viewBox:`0 0 8 8`,fill:`none`,class:`action-btn-caret`,children:$(`path`,{d:`M1.5 3L4 5.5 6.5 3`,stroke:`currentColor`,"stroke-width":`1.2`,"stroke-linecap":`round`,"stroke-linejoin":`round`})})]}),i.value&&$(`div`,{class:`export-menu`,children:[$(`button`,{onClick:()=>{i.value=!1,n()},children:`Export as DOCX`}),$(`button`,{onClick:()=>{i.value=!1,r()},children:`Export as Markdown`})]})]}),$(`button`,{class:`action-btn`,onClick:e,children:[$(`svg`,{width:`14`,height:`14`,viewBox:`0 0 14 14`,fill:`none`,children:$(`path`,{d:`M7 1v12M1 7h12`,stroke:`currentColor`,"stroke-width":`1.5`,"stroke-linecap":`round`})}),`New`]}),!d&&$(`button`,{class:`action-btn ${Yt.value?`active`:``}`,onClick:()=>{Yt.value=!Yt.value,window.__changedownDecorationsActive||(Yt.value?qx():Kx())},title:Yt.value?`Hide delimiters`:`Show delimiters`,children:[$(`svg`,{width:`14`,height:`14`,viewBox:`0 0 14 14`,fill:`none`,children:$(`path`,{d:`M4.5 2C3.12 2 2 3.34 2 5s1.12 3 2.5 3M9.5 2C10.88 2 12 3.34 12 5s-1.12 3-2.5 3M4.5 8C3.12 8 2 9.34 2 11s1.12 3 2.5 3M9.5 8C10.88 8 12 9.34 12 11s-1.12 3-2.5 3`,stroke:`currentColor`,"stroke-width":`1.3`,"stroke-linecap":`round`})}),`Delimiters`]})]})]})}Xe();function Qx({onDeleteFile:e,onRenameFile:t}){return $(`div`,{class:`sidebar`,children:[$(`div`,{class:`sidebar-header`,children:`Files`}),$(`div`,{class:`sidebar-tree`,children:en.value.map(n=>$($x,{node:n,depth:0,onDeleteFile:e,onRenameFile:t},n.path))})]})}function $x({node:e,depth:t,onDeleteFile:n,onRenameFile:r}){let[i,a]=H(e.expanded??!0),[o,s]=H(!1),[c,l]=H(null),u=Wt.value===e.path,d=e.path.startsWith(`/user/`),f=e.type===`directory`,p=Te(()=>{f?a(e=>!e):Wt.value=e.path},[e.path,f]),m=Te(e=>{!d||f||(e.preventDefault(),l({x:e.clientX,y:e.clientY}))},[d,f]),h=W(null);U(()=>{if(!c)return;let e=e=>{h.current&&h.current.contains(e.target)||l(null)};return window.addEventListener(`mousedown`,e),()=>window.removeEventListener(`mousedown`,e)},[c]);let g=Te(()=>{l(null),confirm(`Delete ${e.name}?`)&&n(e.path)},[e.path,e.name,n]),_=Te(t=>{t.preventDefault();let n=t.target.querySelector(`input`);if(n&&n.value.trim()){let t=n.value.trim();t.endsWith(`.md`)?r(e.path,`/user/${t}`):r(e.path,`/user/${t}.md`)}s(!1)},[e.path,r]);return $(`div`,{class:`tree-item-container`,children:[$(`div`,{class:`tree-item ${u?`active`:``} ${f?`directory`:`file`}`,style:{paddingLeft:`${t*16+8}px`},onClick:p,onContextMenu:m,onDblClick:()=>{d&&!f&&s(!0)},children:[$(`span`,{class:`tree-icon`,children:f?i?`▾`:`▸`:`📄`}),o?$(`form`,{onSubmit:_,class:`rename-form`,children:$(`input`,{type:`text`,value:e.name.replace(/\.md$/,``),autoFocus:!0,onBlur:()=>s(!1)})}):$(`span`,{class:`tree-name`,children:e.name})]}),c&&$(`div`,{ref:h,class:`context-menu`,style:{left:c.x,top:c.y},children:$(`button`,{onClick:g,children:`Delete`})}),f&&i&&e.children?.map(e=>$($x,{node:e,depth:t+1,onDeleteFile:n,onRenameFile:r},e.path))]})}Xe();function eS({host:e,viewportService:t}){let n=W(null),r=W(!1);return U(()=>{if(!n.current||!e||r.current)return;r.current=!0;let i=[];return i.push(e.onDidEditorReady(({editor:e})=>{let n=e.onDidScrollChange(()=>{t&&(t.captureFromEditor(e),t.requestSync())});i.push(n)})),t?.setEditorActive(!0),e.mount(n.current),()=>{t?.setEditorActive(!1),e.unmount(),i.forEach(e=>e.dispose()),r.current=!1}},[e,t]),U(()=>{let t=n.current;if(!t||!e)return;let r=new ResizeObserver(()=>e.layoutEditor());return r.observe(t),()=>r.disconnect()},[e]),$(`div`,{ref:n,class:`editor-pane`,style:{width:`100%`,height:`100%`}})}Xe();function tS(){let e=Gt.value;return e===`review`&&!Yt.value?`settled`:e}function nS({containerRef:e,viewportService:t}){let n=Te(()=>{let n=e.current;!n||!t||(t.captureFromPreview(n),t.requestSync())},[t]);return $(`div`,{ref:e,class:`markdown-body ct-dark`,"data-view-mode":tS(),onScroll:n,style:{width:`100%`,height:`100%`,overflow:`auto`,overscrollBehaviorY:`contain`,padding:`20px 28px`}})}function rS(e){return e.toLowerCase()}function iS(e){return e.toLowerCase()}function aS({host:e,headerOnly:t,onExpand:n,previewRef:r,viewportService:i,commandRegistry:a}){let o=jt(!1),s=jt(null),c=jt(``),l=jt(null),u=jt(null),d=async(e,t,...n)=>{if(!(!a||l.value)){l.value=e,u.value=null;try{await a.execute(t,e,...n),s.value=null,c.value=``}catch(t){u.value={changeId:e,message:t?.message??`Action failed`}}finally{l.value=null}}},f=(e,t)=>{s.value={changeId:e,action:t},c.value=``,u.value=null},p=()=>{s.value=null,c.value=``,u.value=null},m=Kt.value.filter(e=>e.level>0&&(e.metadata?.author||e.metadata?.discussion?.length||e.status===Y.Proposed)),h=t=>{if(!(!t.range||!e))if(Xt.value!==`preview`){let n=e.getPositionAt(t.range.start),r=e.getPositionAt(t.range.end);n&&r?e.setSelection(n.lineNumber,n.column,r.lineNumber,r.column):n&&e.revealOffset(t.range.start)}else{let n=r?.current;if(n&&i){let r=e.getPositionAtFromCache(Wt.value,t.range.start);r&&i.scrollPreviewToLine(n,r.lineNumber)}}},g=m.filter(e=>e.status===Y.Accepted).length,_=m.filter(e=>e.status===Y.Rejected).length,v=!o.value&&!t;return $(`div`,{class:`change-panel ${o.value?`collapsed`:``}`,children:[$(`div`,{class:`panel-header`,onClick:t?n:()=>{o.value=!o.value},children:[$(`span`,{class:`panel-toggle`,children:v?`▾`:`▸`}),$(`span`,{children:[m.length,` change`,m.length===1?``:`s`,` · `,g,` accepted`,` · `,_,` rejected`]})]}),v&&$(`div`,{class:`panel-entries`,children:m.map((e,t)=>$(`div`,{class:`panel-entry`,"data-change-id":e.id,onClick:()=>h(e),children:[$(`div`,{children:[$(`span`,{class:`panel-author`,children:e.metadata?.author??`unknown`}),$(`span`,{class:`panel-badge panel-badge-${rS(e.type)}`,children:rS(e.type)}),$(`span`,{class:`panel-status`,children:iS(e.status)})]}),e.metadata?.date&&$(`div`,{class:`panel-date`,children:e.metadata.date}),e.metadata?.discussion?.length&&$(`div`,{class:`panel-thread`,children:e.metadata.discussion.map((e,t)=>$(`div`,{children:[e.author,`: `,e.text]},t))}),a&&e.status===Y.Proposed&&$(`div`,{class:`panel-actions`,children:[$(`button`,{class:`panel-action-btn accept`,disabled:l.value===e.id,onClick:t=>{t.stopPropagation(),d(e.id,`changedown.acceptChange`)},children:l.value===e.id?`...`:`Accept`}),$(`button`,{class:`panel-action-btn reject`,disabled:!!l.value,onClick:t=>{t.stopPropagation(),f(e.id,`reject`)},children:`Reject`}),$(`button`,{class:`panel-action-btn request`,disabled:!!l.value,onClick:t=>{t.stopPropagation(),f(e.id,`requestChanges`)},children:`Request Changes`})]}),s.value?.changeId===e.id&&$(`div`,{class:`panel-reason-input`,onClick:e=>e.stopPropagation(),children:[$(`input`,{type:`text`,placeholder:s.value.action===`reject`?`Reason (optional)...`:`What should change?...`,value:c.value,onInput:e=>{c.value=e.target.value},onKeyDown:t=>{t.key===`Enter`&&d(e.id,s.value.action===`reject`?`changedown.rejectChange`:`changedown.requestChanges`,c.value||void 0),t.key===`Escape`&&p()},autoFocus:!0,disabled:!!l.value}),$(`div`,{class:`panel-reason-buttons`,children:[$(`button`,{class:`panel-action-btn confirm`,disabled:!!l.value,onClick:()=>d(e.id,s.value.action===`reject`?`changedown.rejectChange`:`changedown.requestChanges`,c.value||void 0),children:l.value?`...`:`Confirm`}),$(`button`,{class:`panel-action-btn cancel`,disabled:!!l.value,onClick:p,children:`Cancel`})]}),u.value?.changeId===e.id&&$(`div`,{class:`panel-error`,children:u.value.message})]})]},e.id||t))})]})}Xe();var oS=[`downloading`,`converting`,`extracting`],sS={downloading:0,converting:1,extracting:2},cS={downloading:`Downloading Pandoc`,converting:`Converting document`,extracting:`Extracting media`};function lS({state:e,onCancel:t}){let{stage:n,filename:r,error:i}=e,a=W(n).current===`downloading`?oS:oS.filter(e=>e!==`downloading`),o=sS[n],s=a.filter(e=>sS[e]<o).length,c=i?0:Math.round((s+1)/(a.length+1)*100);return $(`div`,{class:`import-modal-backdrop`,children:$(`div`,{class:`import-modal`,children:[$(`button`,{class:`import-modal-close`,onClick:t,title:`Cancel import`,children:`×`}),$(`div`,{class:`import-modal-icon`,children:`📄`}),$(`div`,{class:`import-modal-title`,children:i?`Import Failed`:`Importing DOCX`}),$(`div`,{class:`import-modal-filename`,children:r}),i?$(`div`,{class:`import-modal-error`,children:i}):$(`div`,{class:`import-modal-steps`,children:a.map(e=>{let t=sS[e],n=t<o,r=t===o;return $(`div`,{class:`import-step${n?` done`:``}${r?` active`:``}`,children:[$(`span`,{class:`import-step-icon`,children:[n&&$(`span`,{style:`color: #4ade80`,children:`✓`}),r&&$(`span`,{class:`import-spinner`,children:`⟳`}),!n&&!r&&$(`span`,{style:`color: var(--text-muted, #555)`,children:`○`})]}),$(`span`,{class:`import-step-label`,children:cS[e]})]},e)})}),$(`div`,{class:`import-progress-bar`,children:$(`div`,{class:`import-progress-fill`,style:{width:`${c}%`}})})]})})}Xe();function uS({commandRegistry:e,...t}){let n=W(null),r=jt(!1),i=jt(!0),a=jt(!0),o=Te(e=>{Qt.value=e,e&&(r.value=!1)},[]),s=Te(e=>{e.preventDefault()},[]),c=Te(e=>{e.preventDefault(),e.dataTransfer?.types.includes(`Files`)&&n.current?.classList.add(`drag-active`)},[]),l=Te(e=>{let t=e.relatedTarget,r=e.currentTarget;(!t||!r.contains(t))&&n.current?.classList.remove(`drag-active`)},[]),u=Te(e=>{e.preventDefault(),n.current?.classList.remove(`drag-active`);let r=e.dataTransfer?.files;if(r){for(let e=0;e<r.length;e++)if(r[e].name.endsWith(`.docx`)){t.onDropFile?.(r[e]);return}}},[]);Rt(()=>{Xt.value===`file`&&requestAnimationFrame(()=>t.host?.layoutEditor())}),Rt(()=>{i.value&&$t.value&&requestAnimationFrame(()=>t.host?.layoutEditor())});let d=$t.value,f=Xt.value===`file`,p=$(v,{children:[$(`button`,{class:`pane-hide-btn sidebar-hide-btn`,onClick:()=>{Qt.value=!1},title:`Hide files`,children:`×`}),$(Qx,{onDeleteFile:t.onDeleteFile,onRenameFile:t.onRenameFile})]});return $(`div`,{ref:n,class:`app`,onDragOver:s,onDragEnter:c,onDragLeave:l,onDrop:u,children:[$(`input`,{ref:t.importInputRef,type:`file`,accept:`.docx`,style:{display:`none`},onChange:t.onImportDocxFile}),nn.value&&$(lS,{state:nn.value,onCancel:t.onCancelImport}),$(Zx,{onNewFile:t.onNewFile,onImportDocx:t.onImportDocx,onExportDocx:t.onExportDocx,onExportMd:t.onExportMd}),$(`div`,{class:`app-body`,children:[d?$(Hx,{open:Qt.value,onOpenChange:e=>o(e),children:$(bx,{children:[$(Xg,{className:`sidebar-backdrop`}),$(_x,{className:`app-sidebar sidebar-drawer`,children:p})]})}):$(`div`,{class:`app-sidebar${Qt.value?``:` collapsed`}`,children:p}),$(`main`,{class:`app-main ${f?`split-view`:`preview-only`}`,children:[f&&!d&&$(v,{children:[$(`div`,{class:`split-pane split-pane-editor`,children:$(eS,{host:t.host,viewportService:t.viewportService})}),$(`div`,{class:`split-handle`})]}),f&&d&&$(v,{children:[$(`button`,{class:`section-header`,onClick:()=>{i.value=!i.value},children:[$(`span`,{class:`section-toggle`,children:i.value?`▼`:`▶`}),$(`span`,{children:`Editor`})]}),$(`div`,{class:`split-pane split-pane-editor${i.value?``:` mobile-collapsed`}`,children:$(eS,{host:t.host,viewportService:t.viewportService})}),$(`button`,{class:`section-header`,onClick:()=>{a.value=!a.value},children:[$(`span`,{class:`section-toggle`,children:a.value?`▼`:`▶`}),$(`span`,{children:`Preview`})]})]}),$(`div`,{class:`split-pane split-pane-preview${f&&d&&!a.value?` mobile-collapsed`:``}`,children:$(nS,{containerRef:t.previewRef,viewportService:t.viewportService})})]})]}),d?$(v,{children:[r.value&&$(`div`,{class:`sheet-backdrop`,onClick:()=>{r.value=!1}}),$(`div`,{class:`change-panel mobile-sheet ${r.value?`expanded`:`peek`}`,children:$(aS,{host:t.host,headerOnly:!r.value,onExpand:()=>{r.value=!0},previewRef:t.previewRef,viewportService:t.viewportService,commandRegistry:e})})]}):$(aS,{host:t.host,previewRef:t.previewRef,viewportService:t.viewportService,commandRegistry:e})]})}Xe();var dS=new Ht(Ro);function fS({initialContentPath:e}){let t=W(null),n=W(null),r=W(dt(null)),i=W(null),a=W(null),o=W([]),s=W([]),c=W(null),l=W(null),u=W(null);Xm(),U(()=>{let t;async function d(){let d=Mi().catch(e=>(console.warn(`[App] LSP client failed to start:`,e),null)),f=Lo?globalThis.__changedown_preload:void 0;if(Lo)f&&await Ro.writeFile(f.path,f.content),await Bo();else{await Ro.mkdir(`/content`),await Ro.mkdir(`/user`);let e=Object.keys({"/public/content/01-index.md":0,"/public/content/02-editing-example.md":0,"/public/content/03-install.md":0,"/public/content/04-spec.md":0,"/public/content/06-about-site.md":0,"/public/content/07-ideas.md":0,"/public/content/posts/01-for-collaboration-a-file-format-is-all-you-need.md":0}),t=!1;for(let n of e){let e=n.replace(/^\/public/,``);try{let n=await fetch(e);if(n.ok){if(e.endsWith(`.docx`)){let t=await n.arrayBuffer();await Ro.writeFile(e,new Uint8Array(t))}else{let t=await n.text();await Ro.writeFile(e,t)}t=!0}}catch{}}t||await Ro.writeFile(Ut,`# Welcome

Start editing here.
`),await Bo()}t=Ro.watch(async()=>{await Bo()});let p;p=Lo?f?f.path:(await Ro.readdir(`/`)).find(e=>e.type===`file`&&e.name.endsWith(`.md`))?.path??e:e,globalThis.__changedown_openFile=async(e,t)=>{if(Lo){let t=(await Ro.readdir(`/`)).find(t=>t.name===e);Wt.value=t?t.path:`/${e}`}else{let n=`/user/${e}`;await Ro.writeFile(n,t),Wt.value=n}tn.value=!0},globalThis.__changedown_importDocxFile=e=>{let t=new AbortController;c.current=t,Wo(e,t).then(()=>{c.current=null})};let m=await d;if(m){let e=new qo;a.current=e;let t=new Qs(Ro),c=new nc,d=new Ym(Ro,dS,e),f=new ec(t,c,d,m);n.current=f,r.current.value=t;let h=new Bi(f.lsp),g=new Hi(f.lsp),_=new Vi(f.stateManager);o.current=[h,g,_],s.current=[Jo(h),Yo(g,e=>t.applyEdits(f.getActiveUri(),e)),Xo(_)],s.current.push(t.onDidChangeCursorPosition(e=>{_.updateCursorContext(e.uri,e.offset)})),e.startSync(()=>t.getEditorInstance(),()=>i.current);let v=()=>{i.current&&d.setContainer(i.current)};v(),requestAnimationFrame(v),t.onDidChangeContent(e=>{!e.isEcho&&!tn.value&&(tn.value=!0)});let y=Fi(g,()=>f.getActiveUri());l.current=y;let b=new Ja(m,()=>f.getActiveUri());u.current=b,ji(()=>b.refresh()),s.current.push(t.onDidEditorReady(({editor:e})=>{y&&(e.addAction({id:`changedown.contextAccept`,label:`Accept Change`,contextMenuGroupId:`changedown`,contextMenuOrder:1,run:()=>{let e=Jt.value;e?.id&&y.execute(`changedown.acceptChange`,e.id)}}),e.addAction({id:`changedown.contextReject`,label:`Reject Change`,contextMenuGroupId:`changedown`,contextMenuOrder:2,run:()=>{let e=Jt.value;e?.id&&y.execute(`changedown.rejectChange`,e.id)}}))})),To(()=>import(`./chunks/editor.main--PWlXqwC.js`).then(e=>{for(let[t,n]of Object.entries(y.commands))e.editor.registerCommand(t,(e,...t)=>{n(...t)});e.languages.registerCodeLensProvider(`markdown`,b),e.languages.registerDefinitionProvider(`markdown`,{provideDefinition:async(t,n)=>{let r=Ni();if(!r)return null;let i=await r.sendRequest(`textDocument/definition`,{textDocument:{uri:t.uri.toString()},position:{line:n.lineNumber-1,character:n.column-1}});if(!i)return null;let a=Array.isArray(i)?i[0]:i;return a?{uri:e.Uri.parse(a.uri),range:new e.Range(a.range.start.line+1,a.range.start.character+1,a.range.end.line+1,a.range.end.character+1)}:null}})}),__vite__mapDeps([3,4,1,5,6,7])),t.start(),s.current.push(t.onDidChangeActiveDocument(e=>{e&&h.setTrackingEnabled(e.uri,Lo)})),Wt.value=p,Lo&&window.webkit?.messageHandlers?.changedown?.postMessage({action:`ready`})}}d();let f=e=>{tn.value&&(e.preventDefault(),e.returnValue=``)};return window.addEventListener(`beforeunload`,f),()=>{t?.(),s.current.forEach(e=>e.dispose()),o.current.forEach(e=>e.dispose()),a.current?.dispose(),n.current?.dispose(),u.current?.dispose(),Pi(),window.removeEventListener(`beforeunload`,f)}},[]),Rt(()=>{let e=Wt.value;if(!e.endsWith(`.docx`))return;let t=e.split(`/`).pop()??e;Ro.readFile(e).then(async e=>{if(!(e instanceof Uint8Array))return;let n=new File([e.buffer],t,{type:`application/vnd.openxmlformats-officedocument.wordprocessingml.document`}),r=new AbortController;c.current=r,await Wo(n,r),c.current=null}).catch(e=>{console.warn(`[App] DOCX conversion failed:`,e)})});function d(){Lo?window.webkit?.messageHandlers?.changedown?.postMessage({action:`importDocx`}):t.current?.click()}async function f(e){let t=e.target,n=t.files?.[0];if(!n)return;t.value=``;let r=new AbortController;c.current=r,await Wo(n,r),c.current=null}function p(){c.current?.abort(),c.current=null,nn.value=null}return $(uS,{host:r.current.value,viewportService:a.current,previewRef:i,onNewFile:Vo,onImportDocx:d,onExportDocx:Go,onExportMd:Ko,onDeleteFile:Ho,onRenameFile:Uo,onCancelImport:p,importInputRef:t,onImportDocxFile:f,onDropFile:e=>{let t=new AbortController;c.current=t,Wo(e,t).then(()=>{c.current=null})},commandRegistry:l.current})}be();var pS=document.getElementById(`app`),mS=pS.dataset.contentPath||Ut;pS.children.length>0?re($(fS,{initialContentPath:mS}),pS):R($(fS,{initialContentPath:mS}),pS),document.getElementById(`seo-content`)?.remove();export{Ls as a,Qo as c,J as d,s as f,u as g,f as h,El as i,To as l,c as m,Ll as n,Rs as o,o as p,Rl as r,Zo as s,Nl as t,Y as u};